-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\Complex4Multiply_block146.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block146
...
ENTITY Complex4Multiply_block146 IS
...
END Complex4Multiply_block146;


ARCHITECTURE rtl OF Complex4Multiply_block146 IS
  ...
  SIGNAL twdl_7_34_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_7_34_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_34_re_tmp               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_34_im_tmp               : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  twdl_7_34_re_signed <= signed(twdl_7_34_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_re_reg <= twdl_7_34_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_7_34_im_signed <= signed(twdl_7_34_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_im_reg <= twdl_7_34_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_34_re_tmp <= mulResFP_re(29 DOWNTO 14);

  twdlXdin_34_re <= std_logic_vector(twdlXdin_34_re_tmp);

  twdlXdin_34_im_tmp <= mulResFP_im(29 DOWNTO 14);
