-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block24.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block24
...
ENTITY TWDLMULT_SDNF1_7_block24 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_51_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_51_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_52_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_52_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block24;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block24 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block159
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block160
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block159
    USE ENTITY work.Complex4Multiply_block159(rtl);

  FOR ALL : Complex4Multiply_block160
    USE ENTITY work.Complex4Multiply_block160(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block159
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_51_re => twdl_7_51_re,  -- sfix16_En14
              twdl_7_51_im => twdl_7_51_im,  -- sfix16_En14
              twdlXdin_51_re => twdlXdin_51_re_tmp,  -- sfix16_En14
              twdlXdin_51_im => twdlXdin_51_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block160
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
