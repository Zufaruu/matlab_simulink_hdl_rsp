-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_5_block27.vhd
...
ENTITY TWDLMULT_SDNF1_5_block27 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_5_57_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_5_57_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block27 IS
  ...
  COMPONENT Complex4Multiply_block115
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block115
    USE ENTITY work.Complex4Multiply_block115(rtl);

  -- Signals
  SIGNAL dout_50_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_50_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block114
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_5_57_re => twdl_5_57_re,  -- sfix16_En14
              twdl_5_57_im => twdl_5_57_im,  -- sfix16_En14
              twdlXdin_57_re => twdlXdin_57_re_tmp,  -- sfix16_En14
              twdlXdin_57_im => twdlXdin_57_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block115
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
