-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_3.vhd
...
ENTITY TWDLMULT_SDNF1_3 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_2_1_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_1_im                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_2_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_2_im                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3 IS
  ...
  SIGNAL dout_2_2_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_2_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_2 : Complex4Multiply
    PORT MAP( clk => clk,
              ...
              twdlXdin_2_re => twdlXdin_2_re_tmp,  -- sfix16_En14
              twdlXdin_2_im => twdlXdin_2_im_tmp,  -- sfix16_En14
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_re_dly1 <= dout_2_1_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_im_dly1 <= dout_2_1_im_signed;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_re_dly1 <= dout_2_2_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_im_dly1 <= dout_2_2_im_signed;
      END IF;
    END IF;
