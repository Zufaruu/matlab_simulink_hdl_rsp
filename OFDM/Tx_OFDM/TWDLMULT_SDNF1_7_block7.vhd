-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block7
...
ENTITY TWDLMULT_SDNF1_7_block7 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_18_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_18_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block7;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block7 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block134
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block134
    USE ENTITY work.Complex4Multiply_block134(rtl);

  -- Signals
  SIGNAL dout_17_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dout_17_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_2 : Complex4Multiply_block134
    PORT MAP( clk => clk,
              reset => reset,
