-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLROM_5_56.vhd
...
-- 
-- Module: TWDLROM_5_56
-- Source Path: Tx_OFDM/Transmitter/IFFT/TWDLROM_5_56
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF TWDLROM_5_56 IS
  ...
  SIGNAL twdl_5_56_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_5_56_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      Radix22TwdlMapping_cnt <= to_unsigned(16#1C#, 6);
  ...
  BEGIN
    ...
    Radix22TwdlMapping_cnt_next <= to_unsigned(16#1C#, 6);
