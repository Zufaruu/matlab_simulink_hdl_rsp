-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_5_block28.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block28 IS
  ...
  COMPONENT Complex4Multiply_block116
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block117
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block116
    USE ENTITY work.Complex4Multiply_block116(rtl);

  FOR ALL : Complex4Multiply_block117
    USE ENTITY work.Complex4Multiply_block117(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block116
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_MUL4_2 : Complex4Multiply_block117
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
