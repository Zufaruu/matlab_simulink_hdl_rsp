-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_SDNF1_7_block22.vhd
...
ENTITY RADIX22FFT_SDNF1_7_block22 IS
...
END RADIX22FFT_SDNF1_7_block22;


ARCHITECTURE rtl OF RADIX22FFT_SDNF1_7_block22 IS

  -- Signals
  SIGNAL twdlXdin_46_re_signed            : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_46_im_signed            : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_48_re_signed            : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_48_im_signed            : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      add_cast := resize(twdlXdin_46_re_signed, 17);
      add_cast_0 := resize(twdlXdin_48_re_signed, 17);
      Radix22ButterflyG1_NF_btf1_re_reg_next <= add_cast + add_cast_0;
      sub_cast := resize(twdlXdin_46_re_signed, 17);
      sub_cast_0 := resize(twdlXdin_48_re_signed, 17);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= sub_cast - sub_cast_0;
      add_cast_1 := resize(twdlXdin_46_im_signed, 17);
      add_cast_2 := resize(twdlXdin_48_im_signed, 17);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= add_cast_1 + add_cast_2;
      sub_cast_1 := resize(twdlXdin_46_im_signed, 17);
      sub_cast_2 := resize(twdlXdin_48_im_signed, 17);
