-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\Complex4Multiply_block133.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block133
...
ENTITY Complex4Multiply_block133 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_16_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_16_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdlXdin_16_re                    :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdlXdin_16_im                    :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END Complex4Multiply_block133;


ARCHITECTURE rtl OF Complex4Multiply_block133 IS
  ...
  SIGNAL twdl_7_16_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_7_16_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_16_re_tmp               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_16_im_tmp               : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  twdl_7_16_re_signed <= signed(twdl_7_16_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_re_reg <= twdl_7_16_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_7_16_im_signed <= signed(twdl_7_16_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_im_reg <= twdl_7_16_im_signed;
      END IF;
    END IF;
