...
ENTITY RADIX22FFT_SDNF1_7_block17 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_38_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_38_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_7_block17 IS
  ...
  SIGNAL dout_38_vld                      : std_logic;

BEGIN
  u_MUL4_2 : Complex4Multiply_block135
    PORT MAP( clk => clk,
              reset => reset,
  ...
  BEGIN
    ...
    dout_38_vld <= Radix22ButterflyG1_NF_dinXtwdl_vld_dly1;
