...
BEGIN
  ...
  --  step value      = 1
  --  count to value  = 59
  counter_60_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  comp_0_tmp_1 <= '1' WHEN count60 = to_unsigned(16#3B#, 6) ELSE
      '0';
  ...
  enb_1_60_0_1 <= phase_0_1 AND clk_enable;

  enb_1_60_0 <= enb_1_60_0_1;

  
  comp_1_tmp_1 <= '1' WHEN count60 = to_unsigned(16#00#, 6) ELSE
      '0';
  ...
  enb_1_60_1_1 <= phase_1_1 AND clk_enable;

  enb_1_60_1 <= enb_1_60_1_1;
