-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_SDNF2_4_block14.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF2_4_block14 IS
  ...
  -- Signals
  SIGNAL dout_31_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_31_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_31_im_signed,
       dout_31_re_signed, dout_63_im_signed, dout_63_re_signed, rotate_31)
  ...
  dout_31_re_1 <= std_logic_vector(dout_31_re_tmp);

  dout_31_im_1 <= std_logic_vector(dout_31_im_tmp);
