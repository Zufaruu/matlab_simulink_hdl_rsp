-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\SDFCommutator2_block15.vhd
...
ENTITY SDFCommutator2_block15 IS
...
END SDFCommutator2_block15;


ARCHITECTURE rtl OF SDFCommutator2_block15 IS
  ...
  SIGNAL dout_2_17_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_17_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_17_vld                    : std_logic;
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    dout_2_17_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_2_17_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_2_17_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_2_17_re <= std_logic_vector(dout_2_17_re_tmp);

  dout_2_17_im <= std_logic_vector(dout_2_17_im_tmp);
