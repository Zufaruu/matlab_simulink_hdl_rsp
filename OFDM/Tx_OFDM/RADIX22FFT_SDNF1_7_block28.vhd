...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_7_block28 IS
  ...
  COMPONENT Complex4Multiply_block146
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block146
    USE ENTITY work.Complex4Multiply_block146(rtl);
  ...
  SIGNAL dout_60_vld                      : std_logic;

BEGIN
  u_MUL4_2 : Complex4Multiply_block146
    PORT MAP( clk => clk,
              reset => reset,
