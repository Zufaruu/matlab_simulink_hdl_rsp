-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\Complex4Multiply_block155.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block155
...
ENTITY Complex4Multiply_block155 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_46_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_46_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdlXdin_46_re                    :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdlXdin_46_im                    :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END Complex4Multiply_block155;


ARCHITECTURE rtl OF Complex4Multiply_block155 IS
  ...
  SIGNAL twdl_7_46_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_7_46_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_46_re_tmp               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_46_im_tmp               : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  twdl_7_46_re_signed <= signed(twdl_7_46_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_re_reg <= twdl_7_46_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_7_46_im_signed <= signed(twdl_7_46_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_im_reg <= twdl_7_46_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_46_re_tmp <= mulResFP_re(29 DOWNTO 14);

  twdlXdin_46_re <= std_logic_vector(twdlXdin_46_re_tmp);

  twdlXdin_46_im_tmp <= mulResFP_im(29 DOWNTO 14);
