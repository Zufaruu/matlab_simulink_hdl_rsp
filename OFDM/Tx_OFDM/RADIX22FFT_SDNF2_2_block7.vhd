-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_SDNF2_2_block7.vhd
...
ENTITY RADIX22FFT_SDNF2_2_block7 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_1_9_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_1_9_im                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_1_41_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_1_41_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF2_2_block7 IS
  ...
  -- Signals
  SIGNAL dout_1_9_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_1_9_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_1_41_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_1_41_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  dout_1_9_re_signed <= signed(dout_1_9_re);

  dout_1_9_im_signed <= signed(dout_1_9_im);

  dout_1_41_re_signed <= signed(dout_1_41_re);

  dout_1_41_im_signed <= signed(dout_1_41_im);
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_1_vld, dout_1_41_im_signed,
       dout_1_41_re_signed, dout_1_9_im_signed, dout_1_9_re_signed, rotate_64)
  ...
  BEGIN
    ...
    IF rotate_64 /= '0' THEN 
      IF dout_1_1_vld = '1' THEN 
        add_cast_1 := resize(dout_1_9_re_signed, 17);
        add_cast_2 := resize(dout_1_41_im_signed, 17);
        Radix22ButterflyG2_NF_btf1_re_reg_next <= add_cast_1 + add_cast_2;
        sub_cast_1 := resize(dout_1_9_re_signed, 17);
        sub_cast_2 := resize(dout_1_41_im_signed, 17);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= sub_cast_1 - sub_cast_2;
        add_cast_5 := resize(dout_1_9_im_signed, 17);
        add_cast_6 := resize(dout_1_41_re_signed, 17);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= add_cast_5 + add_cast_6;
        sub_cast_5 := resize(dout_1_9_im_signed, 17);
        sub_cast_6 := resize(dout_1_41_re_signed, 17);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= sub_cast_5 - sub_cast_6;
      END IF;
    ELSIF dout_1_1_vld = '1' THEN 
      add_cast := resize(dout_1_9_re_signed, 17);
      add_cast_0 := resize(dout_1_41_re_signed, 17);
      Radix22ButterflyG2_NF_btf1_re_reg_next <= add_cast + add_cast_0;
      sub_cast := resize(dout_1_9_re_signed, 17);
      sub_cast_0 := resize(dout_1_41_re_signed, 17);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= sub_cast - sub_cast_0;
      add_cast_3 := resize(dout_1_9_im_signed, 17);
      add_cast_4 := resize(dout_1_41_im_signed, 17);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= add_cast_3 + add_cast_4;
      sub_cast_3 := resize(dout_1_9_im_signed, 17);
      sub_cast_4 := resize(dout_1_41_im_signed, 17);
