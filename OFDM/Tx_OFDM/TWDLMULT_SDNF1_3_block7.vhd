-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_3_block7.vhd
...
ENTITY TWDLMULT_SDNF1_3_block7 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_2_17_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_17_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_18_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_18_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_1_vld                      :   IN    std_logic;
        twdl_3_17_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_3_17_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block7 IS
  ...
  -- Signals
  SIGNAL dout_2_17_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_17_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_17_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_17_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_2_18_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_18_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block14
    PORT MAP( clk => clk,
              ...
              twdlXdin_17_re => twdlXdin_17_re_tmp,  -- sfix16_En14
              twdlXdin_17_im => twdlXdin_17_im_tmp  -- sfix16_En14
              );
  ...
  u_MUL4_2 : Complex4Multiply_block15
    PORT MAP( clk => clk,
              ...
              twdlXdin_18_re => twdlXdin_18_re_tmp,  -- sfix16_En14
              twdlXdin_18_im => twdlXdin_18_im_tmp  -- sfix16_En14
              );

  dout_2_17_re_signed <= signed(dout_2_17_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_re_dly1 <= dout_2_17_re_signed;
      END IF;
    END IF;
  ...
  dout_2_17_im_signed <= signed(dout_2_17_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_im_dly1 <= dout_2_17_im_signed;
      END IF;
    END IF;
  ...
  dout_2_18_re_signed <= signed(dout_2_18_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_re_dly1 <= dout_2_18_re_signed;
      END IF;
    END IF;
  ...
  dout_2_18_im_signed <= signed(dout_2_18_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_im_dly1 <= dout_2_18_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_17_re <= twdlXdin_17_re_tmp;

  twdlXdin_17_im <= twdlXdin_17_im_tmp;
