-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\Complex4Multiply_block134.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block134
...
ENTITY Complex4Multiply_block134 IS
...
END Complex4Multiply_block134;


ARCHITECTURE rtl OF Complex4Multiply_block134 IS
  ...
  SIGNAL twdl_7_18_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_7_18_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_18_re_tmp               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_18_im_tmp               : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  twdl_7_18_re_signed <= signed(twdl_7_18_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_re_reg <= twdl_7_18_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_7_18_im_signed <= signed(twdl_7_18_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_im_reg <= twdl_7_18_im_signed;
      END IF;
    END IF;
