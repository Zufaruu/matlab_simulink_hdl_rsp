-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_3_block17.vhd
...
ENTITY TWDLMULT_SDNF1_3_block17 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_2_37_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_37_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_38_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_38_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block17 IS
  ...
  -- Signals
  SIGNAL dout_2_37_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_37_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_37_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_37_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_2_38_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_38_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_38_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_38_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block34
    PORT MAP( clk => clk,
              ...
              twdlXdin_37_re => twdlXdin_37_re_tmp,  -- sfix16_En14
              twdlXdin_37_im => twdlXdin_37_im_tmp  -- sfix16_En14
              );
  ...
  u_MUL4_2 : Complex4Multiply_block35
    PORT MAP( clk => clk,
              ...
              twdlXdin_38_re => twdlXdin_38_re_tmp,  -- sfix16_En14
              twdlXdin_38_im => twdlXdin_38_im_tmp  -- sfix16_En14
              );

  dout_2_37_re_signed <= signed(dout_2_37_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_re_dly1 <= dout_2_37_re_signed;
      END IF;
    END IF;
  ...
  dout_2_37_im_signed <= signed(dout_2_37_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_im_dly1 <= dout_2_37_im_signed;
      END IF;
    END IF;
  ...
  dout_2_38_re_signed <= signed(dout_2_38_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_re_dly1 <= dout_2_38_re_signed;
      END IF;
    END IF;
  ...
  dout_2_38_im_signed <= signed(dout_2_38_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_im_dly1 <= dout_2_38_im_signed;
      END IF;
    END IF;
