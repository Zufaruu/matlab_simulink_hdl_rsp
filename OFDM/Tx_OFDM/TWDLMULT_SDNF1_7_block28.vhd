-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block28.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block28
...
ENTITY TWDLMULT_SDNF1_7_block28 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_59_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_59_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_60_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_60_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block28;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block28 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block165
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block166
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block165
    USE ENTITY work.Complex4Multiply_block165(rtl);

  FOR ALL : Complex4Multiply_block166
    USE ENTITY work.Complex4Multiply_block166(rtl);
  ...
  SIGNAL twdlXdin_59_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_59_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL twdlXdin_60_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_60_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_MUL4_1 : Complex4Multiply_block165
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_59_re => twdl_7_59_re,  -- sfix16_En14
              twdl_7_59_im => twdl_7_59_im,  -- sfix16_En14
              twdlXdin_59_re => twdlXdin_59_re_tmp,  -- sfix16_En14
              twdlXdin_59_im => twdlXdin_59_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block166
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
              ...
              twdlXdin_60_re => twdlXdin_60_re_tmp,  -- sfix16_En14
              twdlXdin_60_im => twdlXdin_60_im_tmp  -- sfix16_En14
              );
