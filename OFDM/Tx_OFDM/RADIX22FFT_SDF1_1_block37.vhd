-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_SDF1_1_block37.vhd
...
ENTITY RADIX22FFT_SDF1_1_block37 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb_1_960_0                       :   IN    std_logic;
        din_1_39_re_dly                   :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        din_1_39_im_dly                   :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        din_1_vld_dly                     :   IN    std_logic;
        rd_1_Addr                         :   IN    std_logic;
        rd_1_Enb                          :   IN    std_logic;
        proc_1_enb                        :   IN    std_logic;
        dout_1_39_re                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_1_39_im                      :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END RADIX22FFT_SDF1_1_block37;


ARCHITECTURE rtl OF RADIX22FFT_SDF1_1_block37 IS

  -- Component Declarations
  COMPONENT SDFCommutator1_block37
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SDFCommutator1_block37
    USE ENTITY work.SDFCommutator1_block37(rtl);

  -- Signals
  SIGNAL din_1_39_re_dly_signed           : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dinXTwdl_re                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din_1_39_im_dly_signed           : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dinXTwdl_im                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dinXTwdl_1_39_vld                : std_logic;
  ...
  SIGNAL dout_1_39_re_tmp                 : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_1_39_im_tmp                 : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_SDFCOMMUTATOR_1 : SDFCommutator1_block37
    PORT MAP( clk => clk,
              reset => reset,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_1_39_re => dout_1_39_re_tmp,  -- sfix16_En14
              dout_1_39_im => dout_1_39_im_tmp  -- sfix16_En14
              );

  din_1_39_re_dly_signed <= signed(din_1_39_re_dly);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        dinXTwdl_re <= din_1_39_re_dly_signed;
      END IF;
    END IF;
  END PROCESS intdelay_process;


  din_1_39_im_dly_signed <= signed(din_1_39_im_dly);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        dinXTwdl_im <= din_1_39_im_dly_signed;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        ...
        xf_im <= x_im;
        xf_vld <= x_vld;
        Radix22ButterflyG1_dinXtwdl_vld_dly1 <= proc_1_enb AND dinXTwdl_1_39_vld;
      END IF;
    END IF;
  END PROCESS Radix22ButterflyG1_process;

  dinxTwdlf_vld <= ( NOT proc_1_enb) AND dinXTwdl_1_39_vld;
  ...
  dout_1_39_re <= dout_1_39_re_tmp;

  dout_1_39_im <= dout_1_39_im_tmp;
