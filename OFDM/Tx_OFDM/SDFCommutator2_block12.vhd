-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\SDFCommutator2_block12.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SDFCommutator2_block12
-- Source Path: Tx_OFDM/Transmitter/IFFT/RADIX22FFT_SDF2_2/SDFCommutator2
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SDFCommutator2_block12 IS
...
END SDFCommutator2_block12;


ARCHITECTURE rtl OF SDFCommutator2_block12 IS
  ...
  SIGNAL dout_2_14_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_14_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_14_vld                    : std_logic;
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    dout_2_14_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_2_14_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_2_14_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_2_14_re <= std_logic_vector(dout_2_14_re_tmp);

  dout_2_14_im <= std_logic_vector(dout_2_14_im_tmp);
