...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_7_block26 IS
  ...
  COMPONENT Complex4Multiply_block144
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block144
    USE ENTITY work.Complex4Multiply_block144(rtl);
  ...
  SIGNAL dout_56_vld                      : std_logic;

BEGIN
  u_MUL4_2 : Complex4Multiply_block144
    PORT MAP( clk => clk,
              reset => reset,
  ...
  BEGIN
    ...
    dout_56_vld <= Radix22ButterflyG1_NF_dinXtwdl_vld_dly1;
