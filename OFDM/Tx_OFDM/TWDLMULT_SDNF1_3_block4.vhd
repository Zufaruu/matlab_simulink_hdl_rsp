-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_3_block4.vhd
...
ENTITY TWDLMULT_SDNF1_3_block4 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_2_11_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_11_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_12_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_12_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block4 IS
  ...
  -- Signals
  SIGNAL dout_2_11_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_11_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dout_2_12_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_12_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block8
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_MUL4_2 : Complex4Multiply_block9
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
  ...
  dout_2_11_re_signed <= signed(dout_2_11_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_re_dly1 <= dout_2_11_re_signed;
      END IF;
    END IF;
  ...
  dout_2_11_im_signed <= signed(dout_2_11_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_im_dly1 <= dout_2_11_im_signed;
      END IF;
    END IF;
  ...
  dout_2_12_re_signed <= signed(dout_2_12_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_re_dly1 <= dout_2_12_re_signed;
      END IF;
    END IF;
  ...
  dout_2_12_im_signed <= signed(dout_2_12_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_im_dly1 <= dout_2_12_im_signed;
      END IF;
    END IF;
