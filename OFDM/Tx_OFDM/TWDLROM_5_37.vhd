-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLROM_5_37.vhd
...
-- 
-- Module: TWDLROM_5_37
-- Source Path: Tx_OFDM/Transmitter/IFFT/TWDLROM_5_37
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY TWDLROM_5_37 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb_1_960_0                       :   IN    std_logic;
        dout_4_vld                        :   IN    std_logic;
        twdl_5_37_re                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_5_37_im                      :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END TWDLROM_5_37;


ARCHITECTURE rtl OF TWDLROM_5_37 IS
  ...
  SIGNAL twdl_5_37_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_5_37_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_5_37_re_tmp <= twdlIn_re;
    twdl_5_37_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_5_37_re <= std_logic_vector(twdl_5_37_re_tmp);

  twdl_5_37_im <= std_logic_vector(twdl_5_37_im_tmp);
