-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\Complex4Multiply_block135.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex4Multiply_block135
...
ENTITY Complex4Multiply_block135 IS
...
END Complex4Multiply_block135;


ARCHITECTURE rtl OF Complex4Multiply_block135 IS
  ...
  SIGNAL twdl_7_19_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_7_19_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_19_re_tmp               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_19_im_tmp               : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  twdl_7_19_re_signed <= signed(twdl_7_19_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_re_reg <= twdl_7_19_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_7_19_im_signed <= signed(twdl_7_19_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_im_reg <= twdl_7_19_im_signed;
      END IF;
    END IF;
