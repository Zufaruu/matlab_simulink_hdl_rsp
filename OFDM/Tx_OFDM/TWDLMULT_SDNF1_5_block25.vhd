-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_5_block25.vhd
...
ENTITY TWDLMULT_SDNF1_5_block25 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_5_53_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_5_53_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block25 IS
  ...
  COMPONENT Complex4Multiply_block110
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block111
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block110
    USE ENTITY work.Complex4Multiply_block110(rtl);

  FOR ALL : Complex4Multiply_block111
    USE ENTITY work.Complex4Multiply_block111(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block110
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_MUL4_2 : Complex4Multiply_block111
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
