...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_5_block25 IS
  ...
  COMPONENT Complex4Multiply_block107
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block107
    USE ENTITY work.Complex4Multiply_block107(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block106
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_MUL4_2 : Complex4Multiply_block107
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
