-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_bitNatural_18.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_bitNatural_18
-- Source Path: dsphdl.IFFT/RADIX22FFT_bitNatural_18
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY RADIX22FFT_bitNatural_18 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dMem_re18                         :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dMem_im18                         :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END RADIX22FFT_bitNatural_18;


ARCHITECTURE rtl OF RADIX22FFT_bitNatural_18 IS
  ...
  SIGNAL dMem_re18_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dMem_im18_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dMem_vld18                       : std_logic;
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      fftIdx_cnt <= to_unsigned(16#11#, 7);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        MUXSel <= FFTIdxRev(5 DOWNTO 0) XOR to_unsigned(16#01#, 6);
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdAddrGenBitNaturalP_FFTIdxO <= to_unsigned(16#11#, 7);
  ...
  BEGIN
    ...
    CASE rdAddrGenBitNaturalP_rdState IS
      WHEN '0' =>
        ...
        rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#11#, 7);
        IF sampleCntDly = '1' THEN 
          rdAddrGenBitNaturalP_rdState_next <= '1';
          rdAddrGenBitNaturalP_addrReg_next <= '1';
          rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#51#, 7);
    ...
    dMem_re18_tmp <= memOut_re;
    dMem_im18_tmp <= memOut_im;
    dMem_vld18 <= rdAddrGenBitNaturalP_vldOutReg;
  ...
  dMem_re18 <= std_logic_vector(dMem_re18_tmp);

  dMem_im18 <= std_logic_vector(dMem_im18_tmp);
