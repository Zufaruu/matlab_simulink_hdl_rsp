-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\SDFCommutator1_block51.vhd
...
ENTITY SDFCommutator1_block51 IS
...
END SDFCommutator1_block51;


ARCHITECTURE rtl OF SDFCommutator1_block51 IS
  ...
  SIGNAL dout_1_53_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_1_53_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_1_53_vld                    : std_logic;
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    dout_1_53_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_1_53_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_1_53_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_1_53_re <= std_logic_vector(dout_1_53_re_tmp);

  dout_1_53_im <= std_logic_vector(dout_1_53_im_tmp);
