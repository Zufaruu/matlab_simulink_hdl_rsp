-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_SDF2_2_block57.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDF2_2_block57
...
ENTITY RADIX22FFT_SDF2_2_block57 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_2_59_re                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_59_im                      :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END RADIX22FFT_SDF2_2_block57;


ARCHITECTURE rtl OF RADIX22FFT_SDF2_2_block57 IS

  -- Component Declarations
  COMPONENT SDFCommutator2_block57
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SDFCommutator2_block57
    USE ENTITY work.SDFCommutator2_block57(rtl);
  ...
  SIGNAL dout_2_59_re_tmp                 : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_2_59_im_tmp                 : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_SDFCOMMUTATOR_2 : SDFCommutator2_block57
    PORT MAP( clk => clk,
              reset => reset,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_2_59_re => dout_2_59_re_tmp,  -- sfix16_En14
              dout_2_59_im => dout_2_59_im_tmp  -- sfix16_En14
              );
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din_re_dly1 <= dout_1_59_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din_im_dly1 <= dout_1_59_im_signed;
      END IF;
    END IF;
  ...
  Radix22ButterflyG2_output : PROCESS (Radix22ButterflyG2_btf1_im_reg, Radix22ButterflyG2_btf1_re_reg,
       ...
       btfin_re, btfin_vld, dinVld, dout_1_59_im_signed, dout_1_59_re_signed,
  ...
  BEGIN
    ...
    Radix22ButterflyG2_din_re_dly_next <= dout_1_59_re_signed;
    Radix22ButterflyG2_din_im_dly_next <= dout_1_59_im_signed;
  ...
  dout_2_59_re <= dout_2_59_re_tmp;

  dout_2_59_im <= dout_2_59_im_tmp;
