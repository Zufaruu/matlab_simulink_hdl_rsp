-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\SDFCommutator1_block35.vhd
...
ENTITY SDFCommutator1_block35 IS
...
END SDFCommutator1_block35;


ARCHITECTURE rtl OF SDFCommutator1_block35 IS
  ...
  SIGNAL dout_1_37_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_1_37_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_1_37_vld                    : std_logic;

BEGIN
  u_dataXMEM_re_0_1 : SimpleDualPortRAM_generic_block
  ...
  u_dataXMEM_im_0_1 : SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    ...
    END IF;
    dout_1_37_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_1_37_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_1_37_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_1_37_re <= std_logic_vector(dout_1_37_re_tmp);

  dout_1_37_im <= std_logic_vector(dout_1_37_im_tmp);
