-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLROM_7_2.vhd
...
-- 
-- Module: TWDLROM_7_2
-- Source Path: Tx_OFDM/Transmitter/IFFT/TWDLROM_7_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF TWDLROM_7_2 IS
  ...
  SIGNAL twdl_7_2_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_7_2_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_7_2_re_tmp <= twdlIn_re;
    twdl_7_2_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_7_2_re <= std_logic_vector(twdl_7_2_re_tmp);

  twdl_7_2_im <= std_logic_vector(twdl_7_2_im_tmp);
