-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_3_block14.vhd
...
ENTITY TWDLMULT_SDNF1_3_block14 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_2_31_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_31_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_32_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_32_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block14 IS
  ...
  -- Signals
  SIGNAL dout_2_31_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_31_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dout_2_32_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_32_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block28
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdlXdin_31_re => twdlXdin_31_re_tmp,  -- sfix16_En14
              twdlXdin_31_im => twdlXdin_31_im_tmp  -- sfix16_En14
              );
  ...
  u_MUL4_2 : Complex4Multiply_block29
    PORT MAP( clk => clk,
              ...
              twdlXdin_32_re => twdlXdin_32_re_tmp,  -- sfix16_En14
              twdlXdin_32_im => twdlXdin_32_im_tmp  -- sfix16_En14
              );

  dout_2_31_re_signed <= signed(dout_2_31_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_re_dly1 <= dout_2_31_re_signed;
      END IF;
    END IF;
  ...
  dout_2_31_im_signed <= signed(dout_2_31_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_im_dly1 <= dout_2_31_im_signed;
      END IF;
    END IF;
  ...
  dout_2_32_re_signed <= signed(dout_2_32_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_re_dly1 <= dout_2_32_re_signed;
      END IF;
    END IF;
  ...
  dout_2_32_im_signed <= signed(dout_2_32_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_im_dly1 <= dout_2_32_im_signed;
      END IF;
    END IF;
