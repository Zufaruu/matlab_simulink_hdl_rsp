-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_3_block20.vhd
...
ENTITY TWDLMULT_SDNF1_3_block20 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dout_2_43_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_43_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_44_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dout_2_44_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block20 IS
  ...
  -- Signals
  SIGNAL dout_2_43_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_43_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_43_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_43_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_2_44_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_44_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_44_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_44_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block40
    PORT MAP( clk => clk,
              ...
              twdlXdin_43_re => twdlXdin_43_re_tmp,  -- sfix16_En14
              twdlXdin_43_im => twdlXdin_43_im_tmp  -- sfix16_En14
              );
  ...
  u_MUL4_2 : Complex4Multiply_block41
    PORT MAP( clk => clk,
              ...
              twdlXdin_44_re => twdlXdin_44_re_tmp,  -- sfix16_En14
              twdlXdin_44_im => twdlXdin_44_im_tmp  -- sfix16_En14
              );

  dout_2_43_re_signed <= signed(dout_2_43_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_re_dly1 <= dout_2_43_re_signed;
      END IF;
    END IF;
  ...
  dout_2_43_im_signed <= signed(dout_2_43_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din1_im_dly1 <= dout_2_43_im_signed;
      END IF;
    END IF;
  ...
  dout_2_44_re_signed <= signed(dout_2_44_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_re_dly1 <= dout_2_44_re_signed;
      END IF;
    END IF;
  ...
  dout_2_44_im_signed <= signed(dout_2_44_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        din2_im_dly1 <= dout_2_44_im_signed;
      END IF;
    END IF;
