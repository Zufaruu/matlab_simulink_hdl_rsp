-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_bitNatural_17.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_bitNatural_17
-- Source Path: dsphdl.IFFT/RADIX22FFT_bitNatural_17
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY RADIX22FFT_bitNatural_17 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dMem_re17                         :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dMem_im17                         :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END RADIX22FFT_bitNatural_17;


ARCHITECTURE rtl OF RADIX22FFT_bitNatural_17 IS
  ...
  SIGNAL dMem_re17_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dMem_im17_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dMem_vld17                       : std_logic;
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      fftIdx_cnt <= to_unsigned(16#10#, 7);
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdAddrGenBitNaturalP_FFTIdxO <= to_unsigned(16#10#, 7);
  ...
  BEGIN
    ...
    CASE rdAddrGenBitNaturalP_rdState IS
      WHEN '0' =>
        ...
        rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#10#, 7);
        IF sampleCntDly = '1' THEN 
          rdAddrGenBitNaturalP_rdState_next <= '1';
          rdAddrGenBitNaturalP_addrReg_next <= '1';
          rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#50#, 7);
    ...
    dMem_re17_tmp <= memOut_re;
    dMem_im17_tmp <= memOut_im;
    dMem_vld17 <= rdAddrGenBitNaturalP_vldOutReg;
  ...
  dMem_re17 <= std_logic_vector(dMem_re17_tmp);

  dMem_im17 <= std_logic_vector(dMem_im17_tmp);
