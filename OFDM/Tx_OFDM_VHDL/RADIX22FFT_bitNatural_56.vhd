-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_bitNatural_56.vhd
...
ENTITY RADIX22FFT_bitNatural_56 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dMem_re56                         :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dMem_im56                         :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END RADIX22FFT_bitNatural_56;


ARCHITECTURE rtl OF RADIX22FFT_bitNatural_56 IS
  ...
  SIGNAL dMem_re56_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dMem_im56_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dMem_vld56                       : std_logic;
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      fftIdx_cnt <= to_unsigned(16#37#, 7);
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdAddrGenBitNaturalP_FFTIdxO <= to_unsigned(16#37#, 7);
  ...
  BEGIN
    ...
    CASE rdAddrGenBitNaturalP_rdState IS
      WHEN '0' =>
        ...
        rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#37#, 7);
        IF sampleCntDly = '1' THEN 
          rdAddrGenBitNaturalP_rdState_next <= '1';
          rdAddrGenBitNaturalP_addrReg_next <= '1';
          rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#77#, 7);
    ...
    dMem_re56_tmp <= memOut_re;
    dMem_im56_tmp <= memOut_im;
  ...
  dMem_re56 <= std_logic_vector(dMem_re56_tmp);

  dMem_im56 <= std_logic_vector(dMem_im56_tmp);
