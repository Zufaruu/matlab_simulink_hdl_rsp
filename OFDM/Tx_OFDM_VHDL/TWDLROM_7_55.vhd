-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLROM_7_55.vhd
...
-- 
-- Module: TWDLROM_7_55
-- Source Path: Tx_OFDM/Transmitter/IFFT/TWDLROM_7_55
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY TWDLROM_7_55 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb_1_960_0                       :   IN    std_logic;
        dout_6_vld                        :   IN    std_logic;
        twdl_7_55_re                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_55_im                      :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END TWDLROM_7_55;


ARCHITECTURE rtl OF TWDLROM_7_55 IS
  ...
  SIGNAL twdl_7_55_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_7_55_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_7_55_re_tmp <= twdlIn_re;
    twdl_7_55_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_7_55_re <= std_logic_vector(twdl_7_55_re_tmp);

  twdl_7_55_im <= std_logic_vector(twdl_7_55_im_tmp);
