-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_bitNaturalMux_19.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_bitNaturalMux_19
-- Source Path: dsphdl.IFFT/RADIX22FFT_bitNaturalMux_19
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY RADIX22FFT_bitNaturalMux_19 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dMux_re19                         :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dMux_im19                         :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END RADIX22FFT_bitNaturalMux_19;


ARCHITECTURE rtl OF RADIX22FFT_bitNaturalMux_19 IS
  ...
  SIGNAL dMux_re19_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dMux_im19_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      outMuxSel_idx <= to_unsigned(16#12#, 7);
      outMuxSel_xorCnt <= '0';
  ...
  BEGIN
    IF reset = '1' THEN
      dMux_re19_tmp <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' AND dMuxSelDly_vld = '1' THEN
        dMux_re19_tmp <= dMuxDly_re;
      END IF;
    END IF;
  END PROCESS intdelay_66_process;


  dMux_re19 <= std_logic_vector(dMux_re19_tmp);
  ...
  BEGIN
    IF reset = '1' THEN
      dMux_im19_tmp <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' AND dMuxSelDly_vld = '1' THEN
        dMux_im19_tmp <= dMuxDly_im;
      END IF;
    END IF;
  END PROCESS intdelay_132_process;


  dMux_im19 <= std_logic_vector(dMux_im19_tmp);
