-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block26.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block26
...
ENTITY TWDLMULT_SDNF1_7_block26 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_55_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_55_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_56_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_56_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block26;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block26 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block162
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block163
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block162
    USE ENTITY work.Complex4Multiply_block162(rtl);

  FOR ALL : Complex4Multiply_block163
    USE ENTITY work.Complex4Multiply_block163(rtl);
  ...
  SIGNAL twdlXdin_55_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_55_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL twdlXdin_56_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_56_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_MUL4_1 : Complex4Multiply_block162
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_55_re => twdl_7_55_re,  -- sfix16_En14
              twdl_7_55_im => twdl_7_55_im,  -- sfix16_En14
              twdlXdin_55_re => twdlXdin_55_re_tmp,  -- sfix16_En14
              twdlXdin_55_im => twdlXdin_55_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block163
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
              ...
              twdlXdin_56_re => twdlXdin_56_re_tmp,  -- sfix16_En14
              twdlXdin_56_im => twdlXdin_56_im_tmp  -- sfix16_En14
              );
