-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block4
...
ENTITY TWDLMULT_SDNF1_7_block4 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_11_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_11_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_12_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_12_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block4;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block4 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block129
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block130
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block129
    USE ENTITY work.Complex4Multiply_block129(rtl);

  FOR ALL : Complex4Multiply_block130
    USE ENTITY work.Complex4Multiply_block130(rtl);

  -- Signals
  SIGNAL dout_13_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_13_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dout_15_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_15_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block129
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_11_re => twdl_7_11_re,  -- sfix16_En14
              twdl_7_11_im => twdl_7_11_im,  -- sfix16_En14
              twdlXdin_11_re => twdlXdin_11_re_tmp,  -- sfix16_En14
              twdlXdin_11_im => twdlXdin_11_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block130
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
              ...
              twdlXdin_12_re => twdlXdin_12_re_tmp,  -- sfix16_En14
              twdlXdin_12_im => twdlXdin_12_im_tmp  -- sfix16_En14
              );
