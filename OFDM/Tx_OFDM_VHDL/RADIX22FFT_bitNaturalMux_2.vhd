-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_bitNaturalMux_2.vhd
...
ENTITY RADIX22FFT_bitNaturalMux_2 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dMux_re2                          :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dMux_im2                          :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
...
ARCHITECTURE rtl OF RADIX22FFT_bitNaturalMux_2 IS
  ...
  SIGNAL dMux_re2_tmp                     : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dMux_im2_tmp                     : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      outMuxSel_idx <= to_unsigned(16#01#, 7);
      outMuxSel_xorCnt <= '0';
  ...
  BEGIN
    IF reset = '1' THEN
      dMux_re2_tmp <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' AND dMuxSelDly_vld = '1' THEN
        dMux_re2_tmp <= dMuxDly_re;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      dMux_im2_tmp <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' AND dMuxSelDly_vld = '1' THEN
        dMux_im2_tmp <= dMuxDly_im;
      END IF;
    END IF;
