...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_7_block22 IS
  ...
  COMPONENT Complex4Multiply_block140
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block140
    USE ENTITY work.Complex4Multiply_block140(rtl);
  ...
  SIGNAL dout_48_vld                      : std_logic;

BEGIN
  u_MUL4_2 : Complex4Multiply_block140
    PORT MAP( clk => clk,
              reset => reset,
