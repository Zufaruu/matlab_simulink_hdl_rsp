-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_SDNF1_3_block19.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_3_block19 IS
  ...
  -- Signals
  SIGNAL twdlXdin_37_re_signed            : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_37_im_signed            : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_53_re_signed            : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdlXdin_53_im_signed            : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  Radix22ButterflyG1_NF_output : PROCESS (Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
       ...
       twdlXdin_37_im_signed, twdlXdin_37_re_signed, twdlXdin_53_im_signed,
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      add_cast := resize(twdlXdin_37_re_signed, 17);
      add_cast_0 := resize(twdlXdin_53_re_signed, 17);
      Radix22ButterflyG1_NF_btf1_re_reg_next <= add_cast + add_cast_0;
      sub_cast := resize(twdlXdin_37_re_signed, 17);
      sub_cast_0 := resize(twdlXdin_53_re_signed, 17);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= sub_cast - sub_cast_0;
      add_cast_1 := resize(twdlXdin_37_im_signed, 17);
      add_cast_2 := resize(twdlXdin_53_im_signed, 17);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= add_cast_1 + add_cast_2;
      sub_cast_1 := resize(twdlXdin_37_im_signed, 17);
      sub_cast_2 := resize(twdlXdin_53_im_signed, 17);
