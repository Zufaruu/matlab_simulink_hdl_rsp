-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_bitNatural_55.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_bitNatural_55
-- Source Path: dsphdl.IFFT/RADIX22FFT_bitNatural_55
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY RADIX22FFT_bitNatural_55 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dMem_re55                         :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dMem_im55                         :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END RADIX22FFT_bitNatural_55;


ARCHITECTURE rtl OF RADIX22FFT_bitNatural_55 IS
  ...
  SIGNAL dMem_re55_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dMem_im55_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dMem_vld55                       : std_logic;
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      fftIdx_cnt <= to_unsigned(16#36#, 7);
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdAddrGenBitNaturalP_FFTIdxO <= to_unsigned(16#36#, 7);
  ...
  BEGIN
    ...
    CASE rdAddrGenBitNaturalP_rdState IS
      WHEN '0' =>
        ...
        rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#36#, 7);
        IF sampleCntDly = '1' THEN 
          rdAddrGenBitNaturalP_rdState_next <= '1';
          rdAddrGenBitNaturalP_addrReg_next <= '1';
          rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#76#, 7);
    ...
    dMem_re55_tmp <= memOut_re;
    dMem_im55_tmp <= memOut_im;
    dMem_vld55 <= rdAddrGenBitNaturalP_vldOutReg;
  ...
  dMem_re55 <= std_logic_vector(dMem_re55_tmp);

  dMem_im55 <= std_logic_vector(dMem_im55_tmp);
