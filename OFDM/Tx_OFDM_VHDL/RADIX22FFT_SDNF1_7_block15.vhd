...
ENTITY RADIX22FFT_SDNF1_7_block15 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_34_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_34_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_7_block15 IS
  ...
  COMPONENT Complex4Multiply_block133
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block133
    USE ENTITY work.Complex4Multiply_block133(rtl);
  ...
  SIGNAL dout_34_vld                      : std_logic;

BEGIN
  u_MUL4_2 : Complex4Multiply_block133
    PORT MAP( clk => clk,
              reset => reset,
