-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLROM_3_55.vhd
...
ARCHITECTURE rtl OF TWDLROM_3_55 IS
  ...
  SIGNAL twdl_3_55_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_3_55_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      Radix22TwdlMapping_cnt <= to_unsigned(16#16#, 5);
  ...
  BEGIN
    ...
    END IF;
    Radix22TwdlMapping_cnt_next <= to_unsigned(16#16#, 5);
