-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\Complex4Multiply_block22.vhd
...
ARCHITECTURE rtl OF Complex4Multiply_block22 IS
  ...
  SIGNAL twdl_3_25_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_3_25_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  twdl_3_25_re_signed <= signed(twdl_3_25_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_re_reg <= twdl_3_25_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_3_25_im_signed <= signed(twdl_3_25_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_960_0 = '1' THEN
        twdl_im_reg <= twdl_3_25_im_signed;
      END IF;
    END IF;
