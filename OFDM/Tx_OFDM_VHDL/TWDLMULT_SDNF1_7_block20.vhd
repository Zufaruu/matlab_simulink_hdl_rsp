-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block20.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block20
...
ENTITY TWDLMULT_SDNF1_7_block20 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_43_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_43_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_44_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_44_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block20;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block20 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block153
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block154
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block153
    USE ENTITY work.Complex4Multiply_block153(rtl);

  FOR ALL : Complex4Multiply_block154
    USE ENTITY work.Complex4Multiply_block154(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block153
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_43_re => twdl_7_43_re,  -- sfix16_En14
              twdl_7_43_im => twdl_7_43_im,  -- sfix16_En14
              twdlXdin_43_re => twdlXdin_43_re_tmp,  -- sfix16_En14
              twdlXdin_43_im => twdlXdin_43_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block154
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
