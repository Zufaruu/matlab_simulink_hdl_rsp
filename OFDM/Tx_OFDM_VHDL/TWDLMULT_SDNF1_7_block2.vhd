-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block2.vhd
...
ENTITY TWDLMULT_SDNF1_7_block2 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_7_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_7_im                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_8_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_8_im                       :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block2;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block2 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block126
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block127
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block126
    USE ENTITY work.Complex4Multiply_block126(rtl);

  FOR ALL : Complex4Multiply_block127
    USE ENTITY work.Complex4Multiply_block127(rtl);

  -- Signals
  SIGNAL dout_6_re_signed                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_6_im_signed                 : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dout_8_re_signed                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_8_im_signed                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block126
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdlXdin_7_re => twdlXdin_7_re_tmp,  -- sfix16_En14
              twdlXdin_7_im => twdlXdin_7_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block127
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
              ...
              twdlXdin_8_re => twdlXdin_8_re_tmp,  -- sfix16_En14
              twdlXdin_8_im => twdlXdin_8_im_tmp  -- sfix16_En14
              );
