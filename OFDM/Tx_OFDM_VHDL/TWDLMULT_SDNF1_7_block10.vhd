-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block10
...
ENTITY TWDLMULT_SDNF1_7_block10 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_23_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_23_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_24_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_24_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block10;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block10 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block138
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block139
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block138
    USE ENTITY work.Complex4Multiply_block138(rtl);

  FOR ALL : Complex4Multiply_block139
    USE ENTITY work.Complex4Multiply_block139(rtl);

  -- Signals
  SIGNAL dout_22_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_22_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block138
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_23_re => twdl_7_23_re,  -- sfix16_En14
              twdl_7_23_im => twdl_7_23_im,  -- sfix16_En14
              twdlXdin_23_re => twdlXdin_23_re_tmp,  -- sfix16_En14
              twdlXdin_23_im => twdlXdin_23_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block139
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
              ...
              twdlXdin_24_re => twdlXdin_24_re_tmp,  -- sfix16_En14
              twdlXdin_24_im => twdlXdin_24_im_tmp  -- sfix16_En14
              );
