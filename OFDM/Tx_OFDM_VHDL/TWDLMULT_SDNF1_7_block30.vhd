-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block30.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block30
...
ENTITY TWDLMULT_SDNF1_7_block30 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_63_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_63_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_64_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_64_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block30;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block30 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block168
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block169
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block168
    USE ENTITY work.Complex4Multiply_block168(rtl);

  FOR ALL : Complex4Multiply_block169
    USE ENTITY work.Complex4Multiply_block169(rtl);
  ...
  SIGNAL twdlXdin_63_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_63_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL twdlXdin_64_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_64_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_MUL4_1 : Complex4Multiply_block168
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_63_re => twdl_7_63_re,  -- sfix16_En14
              twdl_7_63_im => twdl_7_63_im,  -- sfix16_En14
              twdlXdin_63_re => twdlXdin_63_re_tmp,  -- sfix16_En14
              twdlXdin_63_im => twdlXdin_63_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block169
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
              ...
              twdlXdin_64_re => twdlXdin_64_re_tmp,  -- sfix16_En14
              twdlXdin_64_im => twdlXdin_64_im_tmp  -- sfix16_En14
              );
