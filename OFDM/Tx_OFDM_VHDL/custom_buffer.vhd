...
ARCHITECTURE rtl OF custom_buffer IS
  ...
  SIGNAL HDL_Counter_Initial_Val_out      : unsigned(15 DOWNTO 0);  -- uint16
  ...
  SIGNAL HDL_Counter_out                  : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL HDL_Counter_out_1                : unsigned(15 DOWNTO 0);  -- uint16
...
BEGIN
  ...
  u_buffer : buffer_rsvd
    PORT MAP( clk => clk,
              ...
              counter => std_logic_vector(HDL_Counter_out1),  -- uint16
  ...
  HDL_Counter_Initial_Val_out <= to_unsigned(16#0001#, 16);
  ...
  count_from <= to_unsigned(16#0001#, 16);

  count <= HDL_Counter_out1 + count_step;

  
  need_to_wrap <= '1' WHEN HDL_Counter_out1 = to_unsigned(16#0040#, 16) ELSE
      '0';
