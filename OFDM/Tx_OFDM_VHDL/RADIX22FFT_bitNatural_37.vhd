-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\RADIX22FFT_bitNatural_37.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_bitNatural_37
-- Source Path: dsphdl.IFFT/RADIX22FFT_bitNatural_37
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY RADIX22FFT_bitNatural_37 IS
  PORT( clk                               :   IN    std_logic;
        ...
        dMem_re37                         :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        dMem_im37                         :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END RADIX22FFT_bitNatural_37;


ARCHITECTURE rtl OF RADIX22FFT_bitNatural_37 IS
  ...
  SIGNAL dMem_re37_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dMem_im37_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dMem_vld37                       : std_logic;
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      fftIdx_cnt <= to_unsigned(16#24#, 7);
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdAddrGenBitNaturalP_FFTIdxO <= to_unsigned(16#24#, 7);
  ...
  BEGIN
    ...
    CASE rdAddrGenBitNaturalP_rdState IS
      WHEN '0' =>
        ...
        rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#24#, 7);
        IF sampleCntDly = '1' THEN 
          rdAddrGenBitNaturalP_rdState_next <= '1';
          rdAddrGenBitNaturalP_addrReg_next <= '1';
          rdAddrGenBitNaturalP_FFTIdxO_next <= to_unsigned(16#64#, 7);
    ...
    dMem_re37_tmp <= memOut_re;
    dMem_im37_tmp <= memOut_im;
    dMem_vld37 <= rdAddrGenBitNaturalP_vldOutReg;
  ...
  dMem_re37 <= std_logic_vector(dMem_re37_tmp);

  dMem_im37 <= std_logic_vector(dMem_im37_tmp);
