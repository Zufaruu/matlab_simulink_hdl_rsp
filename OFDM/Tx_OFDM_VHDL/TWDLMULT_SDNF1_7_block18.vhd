-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block18.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block18
...
ENTITY TWDLMULT_SDNF1_7_block18 IS
...
END TWDLMULT_SDNF1_7_block18;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block18 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block150
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block151
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block150
    USE ENTITY work.Complex4Multiply_block150(rtl);

  FOR ALL : Complex4Multiply_block151
    USE ENTITY work.Complex4Multiply_block151(rtl);
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block150
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_39_re => twdl_7_39_re,  -- sfix16_En14
              twdl_7_39_im => twdl_7_39_im,  -- sfix16_En14
              twdlXdin_39_re => twdlXdin_39_re_tmp,  -- sfix16_En14
              twdlXdin_39_im => twdlXdin_39_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block151
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
