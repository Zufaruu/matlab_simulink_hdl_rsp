-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block8
...
ENTITY TWDLMULT_SDNF1_7_block8 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_19_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_19_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_20_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_20_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block8;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block8 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block135
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block136
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block135
    USE ENTITY work.Complex4Multiply_block135(rtl);

  FOR ALL : Complex4Multiply_block136
    USE ENTITY work.Complex4Multiply_block136(rtl);

  -- Signals
  SIGNAL dout_21_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_21_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block135
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_19_re => twdl_7_19_re,  -- sfix16_En14
              twdl_7_19_im => twdl_7_19_im,  -- sfix16_En14
              twdlXdin_19_re => twdlXdin_19_re_tmp,  -- sfix16_En14
              twdlXdin_19_im => twdlXdin_19_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block136
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
              ...
              twdlXdin_20_re => twdlXdin_20_re_tmp,  -- sfix16_En14
              twdlXdin_20_im => twdlXdin_20_im_tmp  -- sfix16_En14
              );
