-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLROM_3_49.vhd
...
-- 
-- Module: TWDLROM_3_49
-- Source Path: dsphdl.IFFT/TWDLROM_3_49
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY TWDLROM_3_49 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb_1_960_0                       :   IN    std_logic;
        dout_2_vld                        :   IN    std_logic;
        twdl_3_49_re                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_3_49_im                      :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END TWDLROM_3_49;


ARCHITECTURE rtl OF TWDLROM_3_49 IS
  ...
  SIGNAL twdl_3_49_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_3_49_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      Radix22TwdlMapping_cnt <= to_unsigned(16#10#, 5);
  ...
  BEGIN
    ...
    END IF;
    IF dout_2_vld = '1' AND (Radix22TwdlMapping_cnt > to_unsigned(16#00#, 5)) THEN 
      Radix22TwdlMapping_phase_next <= Radix22TwdlMapping_phase + to_unsigned(16#2#, 2);
    END IF;
    Radix22TwdlMapping_cnt_next <= to_unsigned(16#10#, 5);
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_3_49_re_tmp <= twdlIn_re;
    twdl_3_49_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_3_49_re <= std_logic_vector(twdl_3_49_re_tmp);

  twdl_3_49_im <= std_logic_vector(twdl_3_49_im_tmp);
