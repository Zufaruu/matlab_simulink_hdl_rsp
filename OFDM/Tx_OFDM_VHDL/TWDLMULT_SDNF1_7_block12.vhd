-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block12.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block12
...
ENTITY TWDLMULT_SDNF1_7_block12 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_27_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_27_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_28_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_28_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block12;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block12 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block141
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block142
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block141
    USE ENTITY work.Complex4Multiply_block141(rtl);

  FOR ALL : Complex4Multiply_block142
    USE ENTITY work.Complex4Multiply_block142(rtl);

  -- Signals
  SIGNAL dout_29_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_29_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block141
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_27_re => twdl_7_27_re,  -- sfix16_En14
              twdl_7_27_im => twdl_7_27_im,  -- sfix16_En14
              twdlXdin_27_re => twdlXdin_27_re_tmp,  -- sfix16_En14
              twdlXdin_27_im => twdlXdin_27_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block142
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
              ...
              twdlXdin_28_re => twdlXdin_28_re_tmp,  -- sfix16_En14
              twdlXdin_28_im => twdlXdin_28_im_tmp  -- sfix16_En14
              );
