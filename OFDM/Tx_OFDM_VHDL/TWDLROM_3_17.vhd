-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLROM_3_17.vhd
...
-- 
-- Module: TWDLROM_3_17
-- Source Path: dsphdl.IFFT/TWDLROM_3_17
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY TWDLROM_3_17 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb_1_960_0                       :   IN    std_logic;
        dout_2_vld                        :   IN    std_logic;
        twdl_3_17_re                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_3_17_im                      :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END TWDLROM_3_17;


ARCHITECTURE rtl OF TWDLROM_3_17 IS
  ...
  SIGNAL twdl_3_17_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_3_17_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_3_17_re_tmp <= twdlIn_re;
    twdl_3_17_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_3_17_re <= std_logic_vector(twdl_3_17_re_tmp);

  twdl_3_17_im <= std_logic_vector(twdl_3_17_im_tmp);
