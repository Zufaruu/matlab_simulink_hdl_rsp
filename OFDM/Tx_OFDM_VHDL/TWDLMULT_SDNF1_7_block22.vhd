-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM\TWDLMULT_SDNF1_7_block22.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TWDLMULT_SDNF1_7_block22
...
ENTITY TWDLMULT_SDNF1_7_block22 IS
  PORT( clk                               :   IN    std_logic;
        ...
        twdl_7_47_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_47_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_48_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        twdl_7_48_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
...
END TWDLMULT_SDNF1_7_block22;


ARCHITECTURE rtl OF TWDLMULT_SDNF1_7_block22 IS

  -- Component Declarations
  COMPONENT Complex4Multiply_block156
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  COMPONENT Complex4Multiply_block157
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_960_0                     :   IN    std_logic;
  ...
  FOR ALL : Complex4Multiply_block156
    USE ENTITY work.Complex4Multiply_block156(rtl);

  FOR ALL : Complex4Multiply_block157
    USE ENTITY work.Complex4Multiply_block157(rtl);

  -- Signals
  SIGNAL dout_46_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_46_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dout_48_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_48_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  u_MUL4_1 : Complex4Multiply_block156
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdl_7_47_re => twdl_7_47_re,  -- sfix16_En14
              twdl_7_47_im => twdl_7_47_im,  -- sfix16_En14
              twdlXdin_47_re => twdlXdin_47_re_tmp,  -- sfix16_En14
              twdlXdin_47_im => twdlXdin_47_im_tmp  -- sfix16_En14
              );

  u_MUL4_2 : Complex4Multiply_block157
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_960_0 => enb_1_960_0,
