// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\TWDLROM_7_10.v
...
module TWDLROM_7_10
  ...
  input   enb_1_4096_0;
  input   dout_6_vld;
  output  signed [15:0] twdl_7_10_re;  // sfix16_En14
  output  signed [15:0] twdl_7_10_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_7_10_re_1;  // sfix16_En14
  reg signed [15:0] twdl_7_10_im_1;  // sfix16_En14
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_7_10_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_7_10_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_7_10_re = twdl_7_10_re_1;

  assign twdl_7_10_im = twdl_7_10_im_1;

endmodule  // TWDLROM_7_10
