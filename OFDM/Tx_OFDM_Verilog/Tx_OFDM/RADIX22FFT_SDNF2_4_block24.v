// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_4_block24.v
...
module RADIX22FFT_SDNF2_4_block24
  ...
  input   signed [15:0] dout_52_re;  // sfix16_En14
  input   signed [15:0] dout_52_im;  // sfix16_En14
  input   dout_1_vld;
  output  signed [15:0] dout_51_re;  // sfix16_En14
  output  signed [15:0] dout_51_im;  // sfix16_En14
  output  signed [15:0] dout_52_re_1;  // sfix16_En14
  output  signed [15:0] dout_52_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_52_re_2;  // sfix16_En14
  reg signed [15:0] dout_52_im_2;  // sfix16_En14
  reg  dout_4_vld;
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_52_im, dout_52_re, rotate_51) begin
    ...
    if (rotate_51 != 1'b0) begin
      if (dout_1_vld) begin
        ...
        Radix22ButterflyG2_NF_add_cast_2 = {dout_52_im[15], dout_52_im};
        ...
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_52_im[15], dout_52_im};
        ...
        Radix22ButterflyG2_NF_add_cast_6 = {dout_52_re[15], dout_52_re};
        ...
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_52_re[15], dout_52_re};
      ...
      Radix22ButterflyG2_NF_add_cast_0 = {dout_52_re[15], dout_52_re};
      ...
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_52_re[15], dout_52_re};
      ...
      Radix22ButterflyG2_NF_add_cast_4 = {dout_52_im[15], dout_52_im};
      ...
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_52_im[15], dout_52_im};
  ...
  assign dout_52_re_1 = dout_52_re_2;

  assign dout_52_im_1 = dout_52_im_2;

endmodule  // RADIX22FFT_SDNF2_4_block24
