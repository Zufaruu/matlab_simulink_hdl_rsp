// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_4_block8.v
...
module RADIX22FFT_SDNF2_4_block8
  ...
  output  signed [15:0] dout_20_re_1;  // sfix16_En14
  output  signed [15:0] dout_20_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_20_re_2;  // sfix16_En14
  reg signed [15:0] dout_20_im_2;  // sfix16_En14
  reg  dout_4_vld;
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_4_im, dout_4_re, rotate_19) begin
    ...
    if (rotate_19 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_4_re[15], dout_4_re};
        Radix22ButterflyG2_NF_add_cast_2 = {dout_20_im[15], dout_20_im};
        Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast_1 + Radix22ButterflyG2_NF_add_cast_2;
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_4_re[15], dout_4_re};
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_20_im[15], dout_20_im};
        Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast_1 - Radix22ButterflyG2_NF_sub_cast_2;
        Radix22ButterflyG2_NF_add_cast_5 = {dout_4_im[15], dout_4_im};
        Radix22ButterflyG2_NF_add_cast_6 = {dout_20_re[15], dout_20_re};
        Radix22ButterflyG2_NF_btf2_im_reg_next = Radix22ButterflyG2_NF_add_cast_5 + Radix22ButterflyG2_NF_add_cast_6;
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_4_im[15], dout_4_im};
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_20_re[15], dout_20_re};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_4_re[15], dout_4_re};
      Radix22ButterflyG2_NF_add_cast_0 = {dout_20_re[15], dout_20_re};
      Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast + Radix22ButterflyG2_NF_add_cast_0;
      Radix22ButterflyG2_NF_sub_cast = {dout_4_re[15], dout_4_re};
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_20_re[15], dout_20_re};
      Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast - Radix22ButterflyG2_NF_sub_cast_0;
      Radix22ButterflyG2_NF_add_cast_3 = {dout_4_im[15], dout_4_im};
      Radix22ButterflyG2_NF_add_cast_4 = {dout_20_im[15], dout_20_im};
      Radix22ButterflyG2_NF_btf1_im_reg_next = Radix22ButterflyG2_NF_add_cast_3 + Radix22ButterflyG2_NF_add_cast_4;
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_4_im[15], dout_4_im};
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_20_im[15], dout_20_im};
    ...
    dout_20_re_2 = Radix22ButterflyG2_NF_sra_temp_1[15:0];
    Radix22ButterflyG2_NF_sra_temp_2 = Radix22ButterflyG2_NF_btf2_im_reg >>> 8'd1;
    dout_20_im_2 = Radix22ButterflyG2_NF_sra_temp_2[15:0];
...
endmodule  // RADIX22FFT_SDNF2_4_block8
