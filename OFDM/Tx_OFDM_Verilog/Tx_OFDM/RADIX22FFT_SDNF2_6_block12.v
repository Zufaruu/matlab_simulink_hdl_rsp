// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_6_block12.v
...
module RADIX22FFT_SDNF2_6_block12
  ...
  input   dout_1_vld;
  output  signed [15:0] dout_27_re_1;  // sfix16_En14
  output  signed [15:0] dout_27_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_27_re_2;  // sfix16_En14
  reg signed [15:0] dout_27_im_2;  // sfix16_En14
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_27_im, dout_27_re,
       dout_31_im, dout_31_re, rotate_27) begin
    ...
    if (rotate_27 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_27_re[15], dout_27_re};
        ...
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_27_re[15], dout_27_re};
        ...
        Radix22ButterflyG2_NF_add_cast_5 = {dout_27_im[15], dout_27_im};
        ...
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_27_im[15], dout_27_im};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_27_re[15], dout_27_re};
      ...
      Radix22ButterflyG2_NF_sub_cast = {dout_27_re[15], dout_27_re};
      ...
      Radix22ButterflyG2_NF_add_cast_3 = {dout_27_im[15], dout_27_im};
      ...
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_27_im[15], dout_27_im};
