// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_bitNatural_19.v
...
module RADIX22FFT_bitNatural_19
  ...
  input   dout_2_vld;
  output  signed [15:0] dMem_re19;  // sfix16_En14
  output  signed [15:0] dMem_im19;  // sfix16_En14
  ...
  reg signed [15:0] dMem_re19_1;  // sfix16_En14
  reg signed [15:0] dMem_im19_1;  // sfix16_En14
  reg  dMem_vld19;
  reg  startOutW;
  reg  endOutW;
  ...
  always @(posedge clk or posedge reset)
    begin : rdAddrGenBitNaturalP_process
      if (reset == 1'b1) begin
        ...
        rdAddrGenBitNaturalP_FFTIdxO <= 7'b0010010;
  ...
  always @(memOut_im, memOut_re, rdAddrGenBitNaturalP_FFTIdxO,
    ...
    dMem_re19_1 = memOut_re;
    dMem_im19_1 = memOut_im;
  ...
  assign dMem_re19 = dMem_re19_1;

  assign dMem_im19 = dMem_im19_1;

endmodule  // RADIX22FFT_bitNatural_19
