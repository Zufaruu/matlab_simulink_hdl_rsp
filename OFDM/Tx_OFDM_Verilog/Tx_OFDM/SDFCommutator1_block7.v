// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\SDFCommutator1_block7.v
...
module SDFCommutator1_block7
  ...
  reg signed [15:0] dout_1_9_re_1;  // sfix16_En14
  reg signed [15:0] dout_1_9_im_1;  // sfix16_En14
  reg  dout_1_9_vld;
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_1_9_re_1 = SDFOutmux_btf2Pipe_re;
    dout_1_9_im_1 = SDFOutmux_btf2Pipe_im;
  ...
  assign dout_1_9_re = dout_1_9_re_1;

  assign dout_1_9_im = dout_1_9_im_1;

endmodule  // SDFCommutator1_block7
