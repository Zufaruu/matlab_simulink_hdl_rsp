// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF1_7_block13.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDNF1_7_block13
...
module RADIX22FFT_SDNF1_7_block13
  ...
  input   dout_6_vld;
  input   signed [15:0] twdl_7_30_re;  // sfix16_En14
  input   signed [15:0] twdl_7_30_im;  // sfix16_En14
  output  signed [15:0] dout_29_re_1;  // sfix16_En14
  output  signed [15:0] dout_29_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_29_re_2;  // sfix16_En14
  reg signed [15:0] dout_29_im_2;  // sfix16_En14
  ...
  Complex4Multiply_block131 u_MUL4_2 (.clk(clk),
                                      .reset(reset),
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    dout_29_re_2 = Radix22ButterflyG1_NF_sra_temp[15:0];
    Radix22ButterflyG1_NF_sra_temp_0 = Radix22ButterflyG1_NF_btf1_im_reg >>> 8'd1;
    dout_29_im_2 = Radix22ButterflyG1_NF_sra_temp_0[15:0];
...
endmodule  // RADIX22FFT_SDNF1_7_block13
