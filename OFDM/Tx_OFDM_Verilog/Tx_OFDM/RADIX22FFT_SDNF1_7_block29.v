// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF1_7_block29.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDNF1_7_block29
...
module RADIX22FFT_SDNF1_7_block29
  ...
  input   dout_6_vld;
  input   signed [15:0] twdl_7_62_re;  // sfix16_En14
  input   signed [15:0] twdl_7_62_im;  // sfix16_En14
  output  signed [15:0] dout_61_re_1;  // sfix16_En14
  output  signed [15:0] dout_61_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_61_re_2;  // sfix16_En14
  reg signed [15:0] dout_61_im_2;  // sfix16_En14
  ...
  Complex4Multiply_block147 u_MUL4_2 (.clk(clk),
                                      .reset(reset),
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    dout_61_re_2 = Radix22ButterflyG1_NF_sra_temp[15:0];
    Radix22ButterflyG1_NF_sra_temp_0 = Radix22ButterflyG1_NF_btf1_im_reg >>> 8'd1;
    dout_61_im_2 = Radix22ButterflyG1_NF_sra_temp_0[15:0];
    ...
    dout_62_vld = Radix22ButterflyG1_NF_dinXtwdl_vld_dly1;
  end



  assign dout_61_re_1 = dout_61_re_2;

  assign dout_61_im_1 = dout_61_im_2;

  assign dout_62_re = dout_62_re_1;

  assign dout_62_im = dout_62_im_1;

endmodule  // RADIX22FFT_SDNF1_7_block29
