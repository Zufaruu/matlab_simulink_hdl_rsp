// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_bitNatural_61.v
...
module RADIX22FFT_bitNatural_61
  ...
  input   dout_2_vld;
  output  signed [15:0] dMem_re61;  // sfix16_En14
  output  signed [15:0] dMem_im61;  // sfix16_En14
  ...
  reg signed [15:0] dMem_re61_1;  // sfix16_En14
  reg signed [15:0] dMem_im61_1;  // sfix16_En14
  reg  dMem_vld61;
  reg  startOutW;
  reg  endOutW;
  ...
  always @(posedge clk or posedge reset)
    begin : rdAddrGenBitNaturalP_process
      if (reset == 1'b1) begin
        ...
        rdAddrGenBitNaturalP_FFTIdxO <= 7'b0111100;
  ...
  always @(memOut_im, memOut_re, rdAddrGenBitNaturalP_FFTIdxO,
    ...
    dMem_re61_1 = memOut_re;
    dMem_im61_1 = memOut_im;
  ...
  assign dMem_re61 = dMem_re61_1;

  assign dMem_im61 = dMem_im61_1;

endmodule  // RADIX22FFT_bitNatural_61
