// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_bitNatural_55.v
...
module RADIX22FFT_bitNatural_55
  ...
  input   dout_2_vld;
  output  signed [15:0] dMem_re55;  // sfix16_En14
  output  signed [15:0] dMem_im55;  // sfix16_En14
  ...
  reg signed [15:0] dMem_re55_1;  // sfix16_En14
  reg signed [15:0] dMem_im55_1;  // sfix16_En14
  reg  dMem_vld55;
  reg  startOutW;
  reg  endOutW;
  ...
  always @(posedge clk or posedge reset)
    begin : rdAddrGenBitNaturalP_process
      if (reset == 1'b1) begin
        ...
        rdAddrGenBitNaturalP_FFTIdxO <= 7'b0110110;
  ...
  always @(memOut_im, memOut_re, rdAddrGenBitNaturalP_FFTIdxO,
    ...
    dMem_re55_1 = memOut_re;
    dMem_im55_1 = memOut_im;
  ...
  assign dMem_re55 = dMem_re55_1;

  assign dMem_im55 = dMem_im55_1;

endmodule  // RADIX22FFT_bitNatural_55
