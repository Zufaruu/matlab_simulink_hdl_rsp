// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_4_block17.v
...
module RADIX22FFT_SDNF2_4_block17
  ...
  input   dout_1_vld;
  output  signed [15:0] dout_37_re_1;  // sfix16_En14
  output  signed [15:0] dout_37_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_37_re_2;  // sfix16_En14
  reg signed [15:0] dout_37_im_2;  // sfix16_En14
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_37_im, dout_37_re,
       dout_53_im, dout_53_re, rotate_37) begin
    ...
    if (rotate_37 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_37_re[15], dout_37_re};
        ...
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_37_re[15], dout_37_re};
        ...
        Radix22ButterflyG2_NF_add_cast_5 = {dout_37_im[15], dout_37_im};
        ...
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_37_im[15], dout_37_im};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_37_re[15], dout_37_re};
      ...
      Radix22ButterflyG2_NF_sub_cast = {dout_37_re[15], dout_37_re};
      ...
      Radix22ButterflyG2_NF_add_cast_3 = {dout_37_im[15], dout_37_im};
      ...
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_37_im[15], dout_37_im};
