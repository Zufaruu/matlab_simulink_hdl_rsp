// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_bitNatural_8.v
...
module RADIX22FFT_bitNatural_8
  ...
  input   dout_2_vld;
  output  signed [15:0] dMem_re8;  // sfix16_En14
  output  signed [15:0] dMem_im8;  // sfix16_En14
  ...
  reg signed [15:0] dMem_re8_1;  // sfix16_En14
  reg signed [15:0] dMem_im8_1;  // sfix16_En14
  reg  dMem_vld8;
  reg  startOutW;
  reg  endOutW;
  ...
  always @(posedge clk or posedge reset)
    begin : rdAddrGenBitNaturalP_process
      if (reset == 1'b1) begin
        ...
        rdAddrGenBitNaturalP_FFTIdxO <= 7'b0000111;
