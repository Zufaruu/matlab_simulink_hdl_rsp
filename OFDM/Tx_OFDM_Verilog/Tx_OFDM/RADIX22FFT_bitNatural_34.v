// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_bitNatural_34.v
...
module RADIX22FFT_bitNatural_34
  ...
  input   dout_2_vld;
  output  signed [15:0] dMem_re34;  // sfix16_En14
  output  signed [15:0] dMem_im34;  // sfix16_En14
  ...
  reg signed [15:0] dMem_re34_1;  // sfix16_En14
  reg signed [15:0] dMem_im34_1;  // sfix16_En14
  reg  dMem_vld34;
  reg  startOutW;
  reg  endOutW;
  ...
  always @(posedge clk or posedge reset)
    begin : rdAddrGenBitNaturalP_process
      if (reset == 1'b1) begin
        ...
        rdAddrGenBitNaturalP_FFTIdxO <= 7'b0100001;
  ...
  always @(memOut_im, memOut_re, rdAddrGenBitNaturalP_FFTIdxO,
    ...
    dMem_re34_1 = memOut_re;
    dMem_im34_1 = memOut_im;
  ...
  assign dMem_re34 = dMem_re34_1;

  assign dMem_im34 = dMem_im34_1;

endmodule  // RADIX22FFT_bitNatural_34
