// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_6_block23.v
...
module RADIX22FFT_SDNF2_6_block23
  ...
  input   reset;
  input   enb_1_4096_0;
  input   rotate_49;  // ufix1
  input   signed [15:0] dout_49_re;  // sfix16_En14
  input   signed [15:0] dout_49_im;  // sfix16_En14
  input   signed [15:0] dout_53_re;  // sfix16_En14
  input   signed [15:0] dout_53_im;  // sfix16_En14
  input   dout_1_vld;
  output  signed [15:0] dout_49_re_1;  // sfix16_En14
  output  signed [15:0] dout_49_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_49_re_2;  // sfix16_En14
  reg signed [15:0] dout_49_im_2;  // sfix16_En14
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_49_im, dout_49_re,
       dout_53_im, dout_53_re, rotate_49) begin
    ...
    if (rotate_49 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_49_re[15], dout_49_re};
        Radix22ButterflyG2_NF_add_cast_2 = {dout_53_im[15], dout_53_im};
        Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast_1 + Radix22ButterflyG2_NF_add_cast_2;
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_49_re[15], dout_49_re};
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_53_im[15], dout_53_im};
        Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast_1 - Radix22ButterflyG2_NF_sub_cast_2;
        Radix22ButterflyG2_NF_add_cast_5 = {dout_49_im[15], dout_49_im};
        Radix22ButterflyG2_NF_add_cast_6 = {dout_53_re[15], dout_53_re};
        Radix22ButterflyG2_NF_btf2_im_reg_next = Radix22ButterflyG2_NF_add_cast_5 + Radix22ButterflyG2_NF_add_cast_6;
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_49_im[15], dout_49_im};
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_53_re[15], dout_53_re};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_49_re[15], dout_49_re};
      Radix22ButterflyG2_NF_add_cast_0 = {dout_53_re[15], dout_53_re};
      Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast + Radix22ButterflyG2_NF_add_cast_0;
      Radix22ButterflyG2_NF_sub_cast = {dout_49_re[15], dout_49_re};
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_53_re[15], dout_53_re};
      Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast - Radix22ButterflyG2_NF_sub_cast_0;
      Radix22ButterflyG2_NF_add_cast_3 = {dout_49_im[15], dout_49_im};
      Radix22ButterflyG2_NF_add_cast_4 = {dout_53_im[15], dout_53_im};
      Radix22ButterflyG2_NF_btf1_im_reg_next = Radix22ButterflyG2_NF_add_cast_3 + Radix22ButterflyG2_NF_add_cast_4;
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_49_im[15], dout_49_im};
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_53_im[15], dout_53_im};
    ...
    dout_49_re_2 = Radix22ButterflyG2_NF_sra_temp[15:0];
    Radix22ButterflyG2_NF_sra_temp_0 = Radix22ButterflyG2_NF_btf1_im_reg >>> 8'd1;
    dout_49_im_2 = Radix22ButterflyG2_NF_sra_temp_0[15:0];
  ...
  assign dout_49_re_1 = dout_49_re_2;

  assign dout_49_im_1 = dout_49_im_2;

  assign dout_50_re = dout_50_re_1;

  assign dout_50_im = dout_50_im_1;

endmodule  // RADIX22FFT_SDNF2_6_block23
