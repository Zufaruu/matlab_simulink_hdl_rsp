// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\TWDLROM_3_38.v
...
// 
// Module: TWDLROM_3_38
// Source Path: dsphdl.IFFT/TWDLROM_3_38
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module TWDLROM_3_38
  ...
  input   enb_1_4096_0;
  input   dout_2_vld;
  output  signed [15:0] twdl_3_38_re;  // sfix16_En14
  output  signed [15:0] twdl_3_38_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_3_38_re_1;  // sfix16_En14
  reg signed [15:0] twdl_3_38_im_1;  // sfix16_En14
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22TwdlMapping_process
      if (reset == 1'b1) begin
        ...
        Radix22TwdlMapping_cnt <= 5'b00101;
  ...
  always @(Radix22TwdlMapping_cnt, Radix22TwdlMapping_dvldReg1,
    ...
    Radix22TwdlMapping_cnt_next = 5'b00101;
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_3_38_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_3_38_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_3_38_re = twdl_3_38_re_1;

  assign twdl_3_38_im = twdl_3_38_im_1;

endmodule  // TWDLROM_3_38
