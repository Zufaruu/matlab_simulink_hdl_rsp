// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_4_block2.v
...
module RADIX22FFT_SDNF2_4_block2
  ...
  input   dout_1_vld;
  output  signed [15:0] dout_7_re_1;  // sfix16_En14
  output  signed [15:0] dout_7_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_7_re_2;  // sfix16_En14
  reg signed [15:0] dout_7_im_2;  // sfix16_En14
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_23_im, dout_23_re,
       dout_7_im, dout_7_re, rotate_7) begin
    ...
    if (rotate_7 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_7_re[15], dout_7_re};
        ...
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_7_re[15], dout_7_re};
        ...
        Radix22ButterflyG2_NF_add_cast_5 = {dout_7_im[15], dout_7_im};
        ...
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_7_im[15], dout_7_im};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_7_re[15], dout_7_re};
      ...
      Radix22ButterflyG2_NF_sub_cast = {dout_7_re[15], dout_7_re};
      ...
      Radix22ButterflyG2_NF_add_cast_3 = {dout_7_im[15], dout_7_im};
      ...
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_7_im[15], dout_7_im};
    ...
    dout_7_re_2 = Radix22ButterflyG2_NF_sra_temp[15:0];
    Radix22ButterflyG2_NF_sra_temp_0 = Radix22ButterflyG2_NF_btf1_im_reg >>> 8'd1;
    dout_7_im_2 = Radix22ButterflyG2_NF_sra_temp_0[15:0];
...
endmodule  // RADIX22FFT_SDNF2_4_block2
