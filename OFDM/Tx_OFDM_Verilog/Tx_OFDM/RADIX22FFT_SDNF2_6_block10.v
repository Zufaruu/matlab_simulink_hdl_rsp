// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_6_block10.v
...
module RADIX22FFT_SDNF2_6_block10
  ...
  input   signed [15:0] dout_20_re;  // sfix16_En14
  input   signed [15:0] dout_20_im;  // sfix16_En14
  input   signed [15:0] dout_24_re;  // sfix16_En14
  input   signed [15:0] dout_24_im;  // sfix16_En14
  input   dout_1_vld;
  output  signed [15:0] dout_23_re;  // sfix16_En14
  output  signed [15:0] dout_23_im;  // sfix16_En14
  output  signed [15:0] dout_24_re_1;  // sfix16_En14
  output  signed [15:0] dout_24_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_23_re_1;  // sfix16_En14
  reg signed [15:0] dout_23_im_1;  // sfix16_En14
  reg signed [15:0] dout_24_re_2;  // sfix16_En14
  reg signed [15:0] dout_24_im_2;  // sfix16_En14
  reg  dout_6_vld;
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_20_im, dout_20_re,
       dout_24_im, dout_24_re, rotate_23) begin
    ...
    if (rotate_23 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_20_re[15], dout_20_re};
        Radix22ButterflyG2_NF_add_cast_2 = {dout_24_im[15], dout_24_im};
        Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast_1 + Radix22ButterflyG2_NF_add_cast_2;
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_20_re[15], dout_20_re};
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_24_im[15], dout_24_im};
        Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast_1 - Radix22ButterflyG2_NF_sub_cast_2;
        Radix22ButterflyG2_NF_add_cast_5 = {dout_20_im[15], dout_20_im};
        Radix22ButterflyG2_NF_add_cast_6 = {dout_24_re[15], dout_24_re};
        Radix22ButterflyG2_NF_btf2_im_reg_next = Radix22ButterflyG2_NF_add_cast_5 + Radix22ButterflyG2_NF_add_cast_6;
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_20_im[15], dout_20_im};
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_24_re[15], dout_24_re};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_20_re[15], dout_20_re};
      Radix22ButterflyG2_NF_add_cast_0 = {dout_24_re[15], dout_24_re};
      Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast + Radix22ButterflyG2_NF_add_cast_0;
      Radix22ButterflyG2_NF_sub_cast = {dout_20_re[15], dout_20_re};
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_24_re[15], dout_24_re};
      Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast - Radix22ButterflyG2_NF_sub_cast_0;
      Radix22ButterflyG2_NF_add_cast_3 = {dout_20_im[15], dout_20_im};
      Radix22ButterflyG2_NF_add_cast_4 = {dout_24_im[15], dout_24_im};
      Radix22ButterflyG2_NF_btf1_im_reg_next = Radix22ButterflyG2_NF_add_cast_3 + Radix22ButterflyG2_NF_add_cast_4;
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_20_im[15], dout_20_im};
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_24_im[15], dout_24_im};
...
endmodule  // RADIX22FFT_SDNF2_6_block10
