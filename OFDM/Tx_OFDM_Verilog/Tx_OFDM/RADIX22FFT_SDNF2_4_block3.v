// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_4_block3.v
...
module RADIX22FFT_SDNF2_4_block3
  ...
  input   dout_1_vld;
  output  signed [15:0] dout_9_re_1;  // sfix16_En14
  output  signed [15:0] dout_9_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_9_re_2;  // sfix16_En14
  reg signed [15:0] dout_9_im_2;  // sfix16_En14
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_9_im, dout_9_re, rotate_9) begin
    ...
    if (rotate_9 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_9_re[15], dout_9_re};
        Radix22ButterflyG2_NF_add_cast_2 = {dout_25_im[15], dout_25_im};
        Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast_1 + Radix22ButterflyG2_NF_add_cast_2;
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_9_re[15], dout_9_re};
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_25_im[15], dout_25_im};
        Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast_1 - Radix22ButterflyG2_NF_sub_cast_2;
        Radix22ButterflyG2_NF_add_cast_5 = {dout_9_im[15], dout_9_im};
        Radix22ButterflyG2_NF_add_cast_6 = {dout_25_re[15], dout_25_re};
        Radix22ButterflyG2_NF_btf2_im_reg_next = Radix22ButterflyG2_NF_add_cast_5 + Radix22ButterflyG2_NF_add_cast_6;
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_9_im[15], dout_9_im};
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_25_re[15], dout_25_re};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_9_re[15], dout_9_re};
      Radix22ButterflyG2_NF_add_cast_0 = {dout_25_re[15], dout_25_re};
      Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast + Radix22ButterflyG2_NF_add_cast_0;
      Radix22ButterflyG2_NF_sub_cast = {dout_9_re[15], dout_9_re};
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_25_re[15], dout_25_re};
      Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast - Radix22ButterflyG2_NF_sub_cast_0;
      Radix22ButterflyG2_NF_add_cast_3 = {dout_9_im[15], dout_9_im};
      Radix22ButterflyG2_NF_add_cast_4 = {dout_25_im[15], dout_25_im};
      Radix22ButterflyG2_NF_btf1_im_reg_next = Radix22ButterflyG2_NF_add_cast_3 + Radix22ButterflyG2_NF_add_cast_4;
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_9_im[15], dout_9_im};
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_25_im[15], dout_25_im};
    ...
    dout_9_re_2 = Radix22ButterflyG2_NF_sra_temp[15:0];
    Radix22ButterflyG2_NF_sra_temp_0 = Radix22ButterflyG2_NF_btf1_im_reg >>> 8'd1;
    dout_9_im_2 = Radix22ButterflyG2_NF_sra_temp_0[15:0];
...
endmodule  // RADIX22FFT_SDNF2_4_block3
