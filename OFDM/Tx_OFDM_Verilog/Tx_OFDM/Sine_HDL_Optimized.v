// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\Sine_HDL_Optimized.v
...
// Source Path: Tx_OFDM/Transmitter/IQ Modulator/Sine HDL Optimized
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Sine_HDL_Optimized
  ...
  input   reset;
  input   enb;
  input   signed [63:0] u;  // sfix64_En37
  ...
  wire [31:0] LTEp25_1_cast;  // ufix32_En17
  wire LTEp25_relop1;
  ...
  assign Amp50_sub_cast = {15'b0, {insig_out1, 9'b000000000}};
  ...
  assign insig_out1_dtc = {15'b0, {insig_out1, 9'b000000000}};
  ...
  assign LTEp25_1_cast = {15'b0, Point25_out1};
