// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_bitNaturalMux_39.v
...
module RADIX22FFT_bitNaturalMux_39
  ...
  input   dMem_vld1;
  output  signed [15:0] dMux_re39;  // sfix16_En14
  output  signed [15:0] dMux_im39;  // sfix16_En14
  ...
  reg signed [15:0] dMux_re39_1;  // sfix16_En14
  ...
  reg signed [15:0] dMux_im39_1;  // sfix16_En14
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_66_process
      if (reset == 1'b1) begin
        dMux_re39_1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_4096_0 && dMuxSelDly_vld) begin
          dMux_re39_1 <= dMuxDly_re;
        end
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_132_process
      if (reset == 1'b1) begin
        dMux_im39_1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_4096_0 && dMuxSelDly_vld) begin
          dMux_im39_1 <= dMuxDly_im;
        end
      end
    end
  ...
  assign dMux_re39 = dMux_re39_1;

  assign dMux_im39 = dMux_im39_1;

endmodule  // RADIX22FFT_bitNaturalMux_39
