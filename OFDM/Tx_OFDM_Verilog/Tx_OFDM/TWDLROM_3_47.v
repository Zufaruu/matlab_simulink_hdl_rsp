// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\TWDLROM_3_47.v
...
// 
// Module: TWDLROM_3_47
// Source Path: dsphdl.IFFT/TWDLROM_3_47
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module TWDLROM_3_47
  ...
  input   enb_1_4096_0;
  input   dout_2_vld;
  output  signed [15:0] twdl_3_47_re;  // sfix16_En14
  output  signed [15:0] twdl_3_47_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_3_47_re_1;  // sfix16_En14
  reg signed [15:0] twdl_3_47_im_1;  // sfix16_En14
  ...
  always @(posedge clk or posedge reset)
    begin : Radix22TwdlMapping_process
      if (reset == 1'b1) begin
        ...
        Radix22TwdlMapping_cnt <= 5'b01110;
  ...
  always @(Radix22TwdlMapping_cnt, Radix22TwdlMapping_dvldReg1,
    ...
    Radix22TwdlMapping_cnt_next = 5'b01110;
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_3_47_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_3_47_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_3_47_re = twdl_3_47_re_1;

  assign twdl_3_47_im = twdl_3_47_im_1;

endmodule  // TWDLROM_3_47
