// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_6_block8.v
...
module RADIX22FFT_SDNF2_6_block8
  ...
  input   signed [15:0] dout_23_re;  // sfix16_En14
  input   signed [15:0] dout_23_im;  // sfix16_En14
  input   dout_1_vld;
  output  signed [15:0] dout_19_re_1;  // sfix16_En14
  output  signed [15:0] dout_19_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_19_re_2;  // sfix16_En14
  reg signed [15:0] dout_19_im_2;  // sfix16_En14
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_23_im, dout_23_re, rotate_19) begin
    ...
    if (rotate_19 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_19_re[15], dout_19_re};
        Radix22ButterflyG2_NF_add_cast_2 = {dout_23_im[15], dout_23_im};
        Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast_1 + Radix22ButterflyG2_NF_add_cast_2;
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_19_re[15], dout_19_re};
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_23_im[15], dout_23_im};
        Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast_1 - Radix22ButterflyG2_NF_sub_cast_2;
        Radix22ButterflyG2_NF_add_cast_5 = {dout_19_im[15], dout_19_im};
        Radix22ButterflyG2_NF_add_cast_6 = {dout_23_re[15], dout_23_re};
        Radix22ButterflyG2_NF_btf2_im_reg_next = Radix22ButterflyG2_NF_add_cast_5 + Radix22ButterflyG2_NF_add_cast_6;
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_19_im[15], dout_19_im};
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_23_re[15], dout_23_re};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_19_re[15], dout_19_re};
      Radix22ButterflyG2_NF_add_cast_0 = {dout_23_re[15], dout_23_re};
      Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast + Radix22ButterflyG2_NF_add_cast_0;
      Radix22ButterflyG2_NF_sub_cast = {dout_19_re[15], dout_19_re};
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_23_re[15], dout_23_re};
      Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast - Radix22ButterflyG2_NF_sub_cast_0;
      Radix22ButterflyG2_NF_add_cast_3 = {dout_19_im[15], dout_19_im};
      Radix22ButterflyG2_NF_add_cast_4 = {dout_23_im[15], dout_23_im};
      Radix22ButterflyG2_NF_btf1_im_reg_next = Radix22ButterflyG2_NF_add_cast_3 + Radix22ButterflyG2_NF_add_cast_4;
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_19_im[15], dout_19_im};
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_23_im[15], dout_23_im};
    ...
    dout_19_re_2 = Radix22ButterflyG2_NF_sra_temp[15:0];
    Radix22ButterflyG2_NF_sra_temp_0 = Radix22ButterflyG2_NF_btf1_im_reg >>> 8'd1;
    dout_19_im_2 = Radix22ButterflyG2_NF_sra_temp_0[15:0];
  ...
  assign dout_19_re_1 = dout_19_re_2;

  assign dout_19_im_1 = dout_19_im_2;

  assign dout_20_re = dout_20_re_1;

  assign dout_20_im = dout_20_im_1;

endmodule  // RADIX22FFT_SDNF2_6_block8
