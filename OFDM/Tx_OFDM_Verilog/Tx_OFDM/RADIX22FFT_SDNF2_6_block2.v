// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_6_block2.v
...
module RADIX22FFT_SDNF2_6_block2
  ...
  output  signed [15:0] dout_8_re_1;  // sfix16_En14
  output  signed [15:0] dout_8_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_8_re_2;  // sfix16_En14
  reg signed [15:0] dout_8_im_2;  // sfix16_En14
  reg  dout_6_vld;
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_4_im, dout_4_re,
       dout_8_im, dout_8_re, rotate_7) begin
    ...
    if (rotate_7 != 1'b0) begin
      if (dout_1_vld) begin
        ...
        Radix22ButterflyG2_NF_add_cast_2 = {dout_8_im[15], dout_8_im};
        ...
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_8_im[15], dout_8_im};
        ...
        Radix22ButterflyG2_NF_add_cast_6 = {dout_8_re[15], dout_8_re};
        ...
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_8_re[15], dout_8_re};
      ...
      Radix22ButterflyG2_NF_add_cast_0 = {dout_8_re[15], dout_8_re};
      ...
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_8_re[15], dout_8_re};
      ...
      Radix22ButterflyG2_NF_add_cast_4 = {dout_8_im[15], dout_8_im};
      ...
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_8_im[15], dout_8_im};
    ...
    dout_8_re_2 = Radix22ButterflyG2_NF_sra_temp_1[15:0];
    Radix22ButterflyG2_NF_sra_temp_2 = Radix22ButterflyG2_NF_btf2_im_reg >>> 8'd1;
    dout_8_im_2 = Radix22ButterflyG2_NF_sra_temp_2[15:0];
...
endmodule  // RADIX22FFT_SDNF2_6_block2
