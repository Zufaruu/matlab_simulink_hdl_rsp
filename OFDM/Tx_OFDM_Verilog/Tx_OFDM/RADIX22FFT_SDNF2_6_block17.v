// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_6_block17.v
...
module RADIX22FFT_SDNF2_6_block17
  ...
  input   reset;
  input   enb_1_4096_0;
  input   rotate_37;  // ufix1
  input   signed [15:0] dout_34_re;  // sfix16_En14
  input   signed [15:0] dout_34_im;  // sfix16_En14
  input   signed [15:0] dout_38_re;  // sfix16_En14
  input   signed [15:0] dout_38_im;  // sfix16_En14
  input   dout_1_vld;
  output  signed [15:0] dout_37_re;  // sfix16_En14
  output  signed [15:0] dout_37_im;  // sfix16_En14
  output  signed [15:0] dout_38_re_1;  // sfix16_En14
  output  signed [15:0] dout_38_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_38_re_2;  // sfix16_En14
  reg signed [15:0] dout_38_im_2;  // sfix16_En14
  reg  dout_6_vld;
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_38_im, dout_38_re, rotate_37) begin
    ...
    if (rotate_37 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_34_re[15], dout_34_re};
        Radix22ButterflyG2_NF_add_cast_2 = {dout_38_im[15], dout_38_im};
        ...
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_38_im[15], dout_38_im};
        ...
        Radix22ButterflyG2_NF_add_cast_6 = {dout_38_re[15], dout_38_re};
        ...
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_38_re[15], dout_38_re};
      ...
      Radix22ButterflyG2_NF_add_cast_0 = {dout_38_re[15], dout_38_re};
      ...
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_38_re[15], dout_38_re};
      ...
      Radix22ButterflyG2_NF_add_cast_4 = {dout_38_im[15], dout_38_im};
      ...
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_38_im[15], dout_38_im};
  ...
  assign dout_38_re_1 = dout_38_re_2;

  assign dout_38_im_1 = dout_38_im_2;

endmodule  // RADIX22FFT_SDNF2_6_block17
