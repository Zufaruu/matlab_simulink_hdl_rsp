// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF1_5_block10.v
...
module RADIX22FFT_SDNF1_5_block10
  ...
  input   reset;
  input   enb_1_4096_0;
  input   signed [15:0] twdlXdin_20_re;  // sfix16_En14
  input   signed [15:0] twdlXdin_20_im;  // sfix16_En14
  input   signed [15:0] twdlXdin_24_re;  // sfix16_En14
  input   signed [15:0] twdlXdin_24_im;  // sfix16_En14
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    if (twdlXdin_1_vld) begin
      Radix22ButterflyG1_NF_add_cast = {twdlXdin_20_re[15], twdlXdin_20_re};
      Radix22ButterflyG1_NF_add_cast_0 = {twdlXdin_24_re[15], twdlXdin_24_re};
      Radix22ButterflyG1_NF_btf1_re_reg_next = Radix22ButterflyG1_NF_add_cast + Radix22ButterflyG1_NF_add_cast_0;
      Radix22ButterflyG1_NF_sub_cast = {twdlXdin_20_re[15], twdlXdin_20_re};
      Radix22ButterflyG1_NF_sub_cast_0 = {twdlXdin_24_re[15], twdlXdin_24_re};
      Radix22ButterflyG1_NF_btf2_re_reg_next = Radix22ButterflyG1_NF_sub_cast - Radix22ButterflyG1_NF_sub_cast_0;
      Radix22ButterflyG1_NF_add_cast_1 = {twdlXdin_20_im[15], twdlXdin_20_im};
      Radix22ButterflyG1_NF_add_cast_2 = {twdlXdin_24_im[15], twdlXdin_24_im};
      Radix22ButterflyG1_NF_btf1_im_reg_next = Radix22ButterflyG1_NF_add_cast_1 + Radix22ButterflyG1_NF_add_cast_2;
      Radix22ButterflyG1_NF_sub_cast_1 = {twdlXdin_20_im[15], twdlXdin_20_im};
      Radix22ButterflyG1_NF_sub_cast_2 = {twdlXdin_24_im[15], twdlXdin_24_im};
...
endmodule  // RADIX22FFT_SDNF1_5_block10
