// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF1_7_block16.v
...
// -------------------------------------------------------------
// 
// Module: RADIX22FFT_SDNF1_7_block16
...
module RADIX22FFT_SDNF1_7_block16
  ...
  input   dout_6_vld;
  input   signed [15:0] twdl_7_36_re;  // sfix16_En14
  input   signed [15:0] twdl_7_36_im;  // sfix16_En14
  output  signed [15:0] dout_35_re;  // sfix16_En14
  output  signed [15:0] dout_35_im;  // sfix16_En14
  output  signed [15:0] dout_36_re_1;  // sfix16_En14
  output  signed [15:0] dout_36_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_36_re_2;  // sfix16_En14
  reg signed [15:0] dout_36_im_2;  // sfix16_En14
  reg  dout_36_vld;
  ...
  Complex4Multiply_block134 u_MUL4_2 (.clk(clk),
                                      .reset(reset),
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    dout_36_re_2 = Radix22ButterflyG1_NF_sra_temp_1[15:0];
    Radix22ButterflyG1_NF_sra_temp_2 = Radix22ButterflyG1_NF_btf2_im_reg >>> 8'd1;
    dout_36_im_2 = Radix22ButterflyG1_NF_sra_temp_2[15:0];
    dout_36_vld = Radix22ButterflyG1_NF_dinXtwdl_vld_dly1;
  end
  ...
  assign dout_36_re_1 = dout_36_re_2;

  assign dout_36_im_1 = dout_36_im_2;

endmodule  // RADIX22FFT_SDNF1_7_block16
