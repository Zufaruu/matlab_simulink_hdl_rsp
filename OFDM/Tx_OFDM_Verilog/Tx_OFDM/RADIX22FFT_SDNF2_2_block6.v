// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_2_block6.v
...
module RADIX22FFT_SDNF2_2_block6
  ...
  input   signed [15:0] dout_1_8_re;  // sfix16_En14
  input   signed [15:0] dout_1_8_im;  // sfix16_En14
  input   signed [15:0] dout_1_40_re;  // sfix16_En14
  input   signed [15:0] dout_1_40_im;  // sfix16_En14
  input   dout_1_1_vld;
  output  signed [15:0] dout_15_re;  // sfix16_En14
  output  signed [15:0] dout_15_im;  // sfix16_En14
  output  signed [15:0] dout_16_re;  // sfix16_En14
  output  signed [15:0] dout_16_im;  // sfix16_En14
  ...
  reg signed [15:0] dout_16_re_1;  // sfix16_En14
  reg signed [15:0] dout_16_im_1;  // sfix16_En14
  reg  dout_2_vld;
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_1_vld, dout_1_40_im,
       dout_1_40_re, dout_1_8_im, dout_1_8_re, rotate_64) begin
    ...
    if (rotate_64 != 1'b0) begin
      if (dout_1_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_1_8_re[15], dout_1_8_re};
        Radix22ButterflyG2_NF_add_cast_2 = {dout_1_40_im[15], dout_1_40_im};
        Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast_1 + Radix22ButterflyG2_NF_add_cast_2;
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_1_8_re[15], dout_1_8_re};
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_1_40_im[15], dout_1_40_im};
        Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast_1 - Radix22ButterflyG2_NF_sub_cast_2;
        Radix22ButterflyG2_NF_add_cast_5 = {dout_1_8_im[15], dout_1_8_im};
        Radix22ButterflyG2_NF_add_cast_6 = {dout_1_40_re[15], dout_1_40_re};
        Radix22ButterflyG2_NF_btf2_im_reg_next = Radix22ButterflyG2_NF_add_cast_5 + Radix22ButterflyG2_NF_add_cast_6;
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_1_8_im[15], dout_1_8_im};
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_1_40_re[15], dout_1_40_re};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_1_8_re[15], dout_1_8_re};
      Radix22ButterflyG2_NF_add_cast_0 = {dout_1_40_re[15], dout_1_40_re};
      Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast + Radix22ButterflyG2_NF_add_cast_0;
      Radix22ButterflyG2_NF_sub_cast = {dout_1_8_re[15], dout_1_8_re};
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_1_40_re[15], dout_1_40_re};
      Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast - Radix22ButterflyG2_NF_sub_cast_0;
      Radix22ButterflyG2_NF_add_cast_3 = {dout_1_8_im[15], dout_1_8_im};
      Radix22ButterflyG2_NF_add_cast_4 = {dout_1_40_im[15], dout_1_40_im};
      Radix22ButterflyG2_NF_btf1_im_reg_next = Radix22ButterflyG2_NF_add_cast_3 + Radix22ButterflyG2_NF_add_cast_4;
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_1_8_im[15], dout_1_8_im};
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_1_40_im[15], dout_1_40_im};
    ...
    dout_16_re_1 = Radix22ButterflyG2_NF_sra_temp_1[15:0];
    Radix22ButterflyG2_NF_sra_temp_2 = Radix22ButterflyG2_NF_btf2_im_reg >>> 8'd1;
    dout_16_im_1 = Radix22ButterflyG2_NF_sra_temp_2[15:0];
