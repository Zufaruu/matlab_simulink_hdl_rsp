// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDF1_1_block7.v
...
module RADIX22FFT_SDF1_1_block7
  ...
  input   reset;
  input   enb_1_4096_0;
  input   signed [15:0] din_1_9_re_dly;  // sfix16_En14
  input   signed [15:0] din_1_9_im_dly;  // sfix16_En14
  input   din_1_vld_dly;
  input   rd_1_Addr;
  input   rd_1_Enb;
  input   proc_1_enb;
  output  signed [15:0] dout_1_9_re;  // sfix16_En14
  output  signed [15:0] dout_1_9_im;  // sfix16_En14


  reg signed [15:0] dinXTwdl_re;  // sfix16_En14
  reg signed [15:0] dinXTwdl_im;  // sfix16_En14
  reg  dinXTwdl_1_9_vld;
  reg  x_vld;
    ...
    begin : Radix22ButterflyG1_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_4096_0) begin
          ...
          xf_im <= x_im;
          xf_vld <= x_vld;
          Radix22ButterflyG1_dinXtwdl_vld_dly1 <= proc_1_enb && dinXTwdl_1_9_vld;
        end
      end
    end

  assign dinxTwdlf_vld = ( ! proc_1_enb) && dinXTwdl_1_9_vld;
  ...
  SDFCommutator1_block7 u_SDFCOMMUTATOR_1 (.clk(clk),
                                           .reset(reset),
...
endmodule  // RADIX22FFT_SDF1_1_block7
