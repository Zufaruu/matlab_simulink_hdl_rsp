// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_6_block6.v
...
module RADIX22FFT_SDNF2_6_block6
  ...
  input   dout_1_vld;
  output  signed [15:0] dout_15_re;  // sfix16_En14
  output  signed [15:0] dout_15_im;  // sfix16_En14
  output  signed [15:0] dout_16_re_1;  // sfix16_En14
  output  signed [15:0] dout_16_im_1;  // sfix16_En14
  ...
  reg signed [15:0] dout_15_re_1;  // sfix16_En14
  reg signed [15:0] dout_15_im_1;  // sfix16_En14
  reg signed [15:0] dout_16_re_2;  // sfix16_En14
  reg signed [15:0] dout_16_im_2;  // sfix16_En14
  reg  dout_6_vld;
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_12_im, dout_12_re, dout_16_im,
       dout_16_re, dout_1_vld, rotate_15) begin
    ...
    if (rotate_15 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_12_re[15], dout_12_re};
        Radix22ButterflyG2_NF_add_cast_2 = {dout_16_im[15], dout_16_im};
        Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast_1 + Radix22ButterflyG2_NF_add_cast_2;
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_12_re[15], dout_12_re};
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_16_im[15], dout_16_im};
        Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast_1 - Radix22ButterflyG2_NF_sub_cast_2;
        Radix22ButterflyG2_NF_add_cast_5 = {dout_12_im[15], dout_12_im};
        Radix22ButterflyG2_NF_add_cast_6 = {dout_16_re[15], dout_16_re};
        Radix22ButterflyG2_NF_btf2_im_reg_next = Radix22ButterflyG2_NF_add_cast_5 + Radix22ButterflyG2_NF_add_cast_6;
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_12_im[15], dout_12_im};
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_16_re[15], dout_16_re};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_12_re[15], dout_12_re};
      Radix22ButterflyG2_NF_add_cast_0 = {dout_16_re[15], dout_16_re};
      Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast + Radix22ButterflyG2_NF_add_cast_0;
      Radix22ButterflyG2_NF_sub_cast = {dout_12_re[15], dout_12_re};
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_16_re[15], dout_16_re};
      Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast - Radix22ButterflyG2_NF_sub_cast_0;
      Radix22ButterflyG2_NF_add_cast_3 = {dout_12_im[15], dout_12_im};
      Radix22ButterflyG2_NF_add_cast_4 = {dout_16_im[15], dout_16_im};
      Radix22ButterflyG2_NF_btf1_im_reg_next = Radix22ButterflyG2_NF_add_cast_3 + Radix22ButterflyG2_NF_add_cast_4;
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_12_im[15], dout_12_im};
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_16_im[15], dout_16_im};
  ...
  assign dout_16_re_1 = dout_16_re_2;

  assign dout_16_im_1 = dout_16_im_2;

endmodule  // RADIX22FFT_SDNF2_6_block6
