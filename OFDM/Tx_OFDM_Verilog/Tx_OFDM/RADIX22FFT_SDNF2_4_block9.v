// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_4_block9.v
...
module RADIX22FFT_SDNF2_4_block9
  ...
  input   signed [15:0] dout_6_re;  // sfix16_En14
  input   signed [15:0] dout_6_im;  // sfix16_En14
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_22_im, dout_22_re,
       dout_6_im, dout_6_re, rotate_21) begin
    ...
    if (rotate_21 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_6_re[15], dout_6_re};
        ...
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_6_re[15], dout_6_re};
        ...
        Radix22ButterflyG2_NF_add_cast_5 = {dout_6_im[15], dout_6_im};
        ...
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_6_im[15], dout_6_im};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_6_re[15], dout_6_re};
      ...
      Radix22ButterflyG2_NF_sub_cast = {dout_6_re[15], dout_6_re};
      ...
      Radix22ButterflyG2_NF_add_cast_3 = {dout_6_im[15], dout_6_im};
      ...
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_6_im[15], dout_6_im};
...
endmodule  // RADIX22FFT_SDNF2_4_block9
