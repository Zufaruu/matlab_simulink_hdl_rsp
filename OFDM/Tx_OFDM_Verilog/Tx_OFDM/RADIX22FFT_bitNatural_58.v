// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_bitNatural_58.v
...
module RADIX22FFT_bitNatural_58
  ...
  input   dout_2_vld;
  output  signed [15:0] dMem_re58;  // sfix16_En14
  output  signed [15:0] dMem_im58;  // sfix16_En14
  ...
  reg signed [15:0] dMem_re58_1;  // sfix16_En14
  reg signed [15:0] dMem_im58_1;  // sfix16_En14
  reg  dMem_vld58;
  reg  startOutW;
  reg  endOutW;
  ...
  always @(posedge clk or posedge reset)
    begin : rdAddrGenBitNaturalP_process
      if (reset == 1'b1) begin
        ...
        rdAddrGenBitNaturalP_FFTIdxO <= 7'b0111001;
  ...
  always @(memOut_im, memOut_re, rdAddrGenBitNaturalP_FFTIdxO,
    ...
    dMem_re58_1 = memOut_re;
    dMem_im58_1 = memOut_im;
  ...
  assign dMem_re58 = dMem_re58_1;

  assign dMem_im58 = dMem_im58_1;

endmodule  // RADIX22FFT_bitNatural_58
