// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_SDNF2_4_block22.v
...
module RADIX22FFT_SDNF2_4_block22
  ...
  input   dout_1_vld;
  output  signed [15:0] dout_47_re_1;  // sfix16_En14
  output  signed [15:0] dout_47_im_1;  // sfix16_En14
  output  signed [15:0] dout_48_re;  // sfix16_En14
  output  signed [15:0] dout_48_im;  // sfix16_En14
  ...
  reg signed [15:0] dout_47_re_2;  // sfix16_En14
  reg signed [15:0] dout_47_im_2;  // sfix16_En14
  reg signed [15:0] dout_48_re_1;  // sfix16_En14
  reg signed [15:0] dout_48_im_1;  // sfix16_En14
  reg  dout_4_vld;
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_47_im, dout_47_re,
       dout_63_im, dout_63_re, rotate_47) begin
    ...
    if (rotate_47 != 1'b0) begin
      if (dout_1_vld) begin
        Radix22ButterflyG2_NF_add_cast_1 = {dout_47_re[15], dout_47_re};
        Radix22ButterflyG2_NF_add_cast_2 = {dout_63_im[15], dout_63_im};
        Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast_1 + Radix22ButterflyG2_NF_add_cast_2;
        Radix22ButterflyG2_NF_sub_cast_1 = {dout_47_re[15], dout_47_re};
        Radix22ButterflyG2_NF_sub_cast_2 = {dout_63_im[15], dout_63_im};
        Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast_1 - Radix22ButterflyG2_NF_sub_cast_2;
        Radix22ButterflyG2_NF_add_cast_5 = {dout_47_im[15], dout_47_im};
        Radix22ButterflyG2_NF_add_cast_6 = {dout_63_re[15], dout_63_re};
        Radix22ButterflyG2_NF_btf2_im_reg_next = Radix22ButterflyG2_NF_add_cast_5 + Radix22ButterflyG2_NF_add_cast_6;
        Radix22ButterflyG2_NF_sub_cast_5 = {dout_47_im[15], dout_47_im};
        Radix22ButterflyG2_NF_sub_cast_6 = {dout_63_re[15], dout_63_re};
      ...
      Radix22ButterflyG2_NF_add_cast = {dout_47_re[15], dout_47_re};
      Radix22ButterflyG2_NF_add_cast_0 = {dout_63_re[15], dout_63_re};
      Radix22ButterflyG2_NF_btf1_re_reg_next = Radix22ButterflyG2_NF_add_cast + Radix22ButterflyG2_NF_add_cast_0;
      Radix22ButterflyG2_NF_sub_cast = {dout_47_re[15], dout_47_re};
      Radix22ButterflyG2_NF_sub_cast_0 = {dout_63_re[15], dout_63_re};
      Radix22ButterflyG2_NF_btf2_re_reg_next = Radix22ButterflyG2_NF_sub_cast - Radix22ButterflyG2_NF_sub_cast_0;
      Radix22ButterflyG2_NF_add_cast_3 = {dout_47_im[15], dout_47_im};
      Radix22ButterflyG2_NF_add_cast_4 = {dout_63_im[15], dout_63_im};
      Radix22ButterflyG2_NF_btf1_im_reg_next = Radix22ButterflyG2_NF_add_cast_3 + Radix22ButterflyG2_NF_add_cast_4;
      Radix22ButterflyG2_NF_sub_cast_3 = {dout_47_im[15], dout_47_im};
      Radix22ButterflyG2_NF_sub_cast_4 = {dout_63_im[15], dout_63_im};
    ...
    dout_47_re_2 = Radix22ButterflyG2_NF_sra_temp[15:0];
    Radix22ButterflyG2_NF_sra_temp_0 = Radix22ButterflyG2_NF_btf1_im_reg >>> 8'd1;
    dout_47_im_2 = Radix22ButterflyG2_NF_sra_temp_0[15:0];
    Radix22ButterflyG2_NF_sra_temp_1 = Radix22ButterflyG2_NF_btf2_re_reg >>> 8'd1;
    dout_48_re_1 = Radix22ButterflyG2_NF_sra_temp_1[15:0];
    Radix22ButterflyG2_NF_sra_temp_2 = Radix22ButterflyG2_NF_btf2_im_reg >>> 8'd1;
    dout_48_im_1 = Radix22ButterflyG2_NF_sra_temp_2[15:0];
    dout_4_vld = Radix22ButterflyG2_NF_din_vld_dly;
  end



  assign dout_47_re_1 = dout_47_re_2;

  assign dout_47_im_1 = dout_47_im_2;

  assign dout_48_re = dout_48_re_1;

  assign dout_48_im = dout_48_im_1;

endmodule  // RADIX22FFT_SDNF2_4_block22
