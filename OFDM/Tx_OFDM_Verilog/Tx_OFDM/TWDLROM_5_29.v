// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\TWDLROM_5_29.v
...
module TWDLROM_5_29
  ...
  input   enb_1_4096_0;
  input   dout_4_vld;
  output  signed [15:0] twdl_5_29_re;  // sfix16_En14
  output  signed [15:0] twdl_5_29_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_5_29_re_1;  // sfix16_En14
  reg signed [15:0] twdl_5_29_im_1;  // sfix16_En14
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_5_29_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_5_29_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_5_29_re = twdl_5_29_re_1;

  assign twdl_5_29_im = twdl_5_29_im_1;

endmodule  // TWDLROM_5_29
