// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\OFDM\Tx_OFDM_Verilog\Tx_OFDM\RADIX22FFT_bitNatural_1.v
...
module RADIX22FFT_bitNatural_1
  ...
  input   dout_2_vld;
  output  signed [15:0] dMem_re1;  // sfix16_En14
  output  signed [15:0] dMem_im1;  // sfix16_En14
  output  dMem_vld1;
  ...
  reg signed [15:0] dMem_re1_1;  // sfix16_En14
  reg signed [15:0] dMem_im1_1;  // sfix16_En14
  reg  dMem_vld1_1;
  reg  startOutW;
  reg  endOutW;
  ...
  always @(posedge clk or posedge reset)
    begin : rdAddrGenBitNaturalP_process
      if (reset == 1'b1) begin
        ...
        rdAddrGenBitNaturalP_FFTIdxO <= 7'b0000000;
  ...
  always @(memOut_im, memOut_re, rdAddrGenBitNaturalP_FFTIdxO,
    ...
    dMem_re1_1 = memOut_re;
    dMem_im1_1 = memOut_im;
    dMem_vld1_1 = rdAddrGenBitNaturalP_vldOutReg;
  ...
  assign dMem_re1 = dMem_re1_1;

  assign dMem_im1 = dMem_im1_1;

  assign dMem_vld1 = dMem_vld1_1;

endmodule  // RADIX22FFT_bitNatural_1
