// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\TWDLMULT_SDNF1_3_block1.v
...
module TWDLMULT_SDNF1_3_block1
  ...
  input   reset;
  input   enb;
  input   signed [13:0] dout_9_re;  // sfix14_En10
  input   signed [13:0] dout_9_im;  // sfix14_En10
  input   signed [13:0] dout_11_re;  // sfix14_En10
  input   signed [13:0] dout_11_im;  // sfix14_En10
  input   dout_2_vld;
  input   signed [11:0] twdl_3_5_re;  // sfix12_En10
  input   signed [11:0] twdl_3_5_im;  // sfix12_En10
  input   signed [11:0] twdl_3_6_re;  // sfix12_En10
  input   signed [11:0] twdl_3_6_im;  // sfix12_En10
  output  signed [14:0] twdlXdin_5_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_5_im;  // sfix15_En10
  output  signed [14:0] twdlXdin_6_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_6_im;  // sfix15_En10
  ...
  assign din_re = {dout_9_re[13], dout_9_re};
  ...
  assign din_im = {dout_9_im[13], dout_9_im};
  ...
  Complex4Multiply_block2 u_MUL4_1 (.clk(clk),
                                    ...
                                    .twdlXdin_5_re(twdlXdin_5_re),  // sfix15_En10
                                    .twdlXdin_5_im(twdlXdin_5_im)  // sfix15_En10
                                    );

  assign din_re_1 = {dout_11_re[13], dout_11_re};
  ...
  assign din_im_1 = {dout_11_im[13], dout_11_im};
  ...
  Complex4Multiply_block3 u_MUL4_2 (.clk(clk),
                                    ...
                                    .twdlXdin_6_re(twdlXdin_6_re),  // sfix15_En10
                                    .twdlXdin_6_im(twdlXdin_6_im)  // sfix15_En10
                                    );
