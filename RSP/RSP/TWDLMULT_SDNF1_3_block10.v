// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\TWDLMULT_SDNF1_3_block10.v
...
module TWDLMULT_SDNF1_3_block10
  ...
  input   reset;
  input   enb;
  input   signed [13:0] dout_29_re;  // sfix14_En10
  input   signed [13:0] dout_29_im;  // sfix14_En10
  input   signed [13:0] dout_31_re;  // sfix14_En10
  input   signed [13:0] dout_31_im;  // sfix14_En10
  input   dout_2_vld;
  input   signed [11:0] twdl_3_23_re;  // sfix12_En10
  input   signed [11:0] twdl_3_23_im;  // sfix12_En10
  input   signed [11:0] twdl_3_24_re;  // sfix12_En10
  input   signed [11:0] twdl_3_24_im;  // sfix12_En10
  output  signed [14:0] twdlXdin_23_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_23_im;  // sfix15_En10
  output  signed [14:0] twdlXdin_24_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_24_im;  // sfix15_En10
  ...
  assign din_re = {dout_29_re[13], dout_29_re};
  ...
  assign din_im = {dout_29_im[13], dout_29_im};
  ...
  Complex4Multiply_block18 u_MUL4_1 (.clk(clk),
                                     ...
                                     .twdlXdin_23_re(twdlXdin_23_re),  // sfix15_En10
                                     .twdlXdin_23_im(twdlXdin_23_im)  // sfix15_En10
                                     );

  assign din_re_1 = {dout_31_re[13], dout_31_re};
  ...
  assign din_im_1 = {dout_31_im[13], dout_31_im};
  ...
  Complex4Multiply_block19 u_MUL4_2 (.clk(clk),
                                     ...
                                     .twdlXdin_24_re(twdlXdin_24_re),  // sfix15_En10
                                     .twdlXdin_24_im(twdlXdin_24_im)  // sfix15_En10
                                     );
