// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\TWDLMULT_SDNF1_3_block2.v
...
module TWDLMULT_SDNF1_3_block2
  ...
  input   reset;
  input   enb;
  input   signed [13:0] dout_13_re;  // sfix14_En10
  input   signed [13:0] dout_13_im;  // sfix14_En10
  input   signed [13:0] dout_15_re;  // sfix14_En10
  input   signed [13:0] dout_15_im;  // sfix14_En10
  input   dout_2_vld;
  input   signed [11:0] twdl_3_7_re;  // sfix12_En10
  input   signed [11:0] twdl_3_7_im;  // sfix12_En10
  input   signed [11:0] twdl_3_8_re;  // sfix12_En10
  input   signed [11:0] twdl_3_8_im;  // sfix12_En10
  output  signed [14:0] twdlXdin_7_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_7_im;  // sfix15_En10
  output  signed [14:0] twdlXdin_8_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_8_im;  // sfix15_En10
  ...
  assign din_re = {dout_13_re[13], dout_13_re};
  ...
  assign din_im = {dout_13_im[13], dout_13_im};
  ...
  Complex4Multiply_block4 u_MUL4_1 (.clk(clk),
                                    .reset(reset),
                                    .enb(enb),
                                    ...
                                    .twdlXdin_7_re(twdlXdin_7_re),  // sfix15_En10
                                    .twdlXdin_7_im(twdlXdin_7_im)  // sfix15_En10
                                    );

  assign din_re_1 = {dout_15_re[13], dout_15_re};
  ...
  assign din_im_1 = {dout_15_im[13], dout_15_im};
  ...
  Complex4Multiply_block5 u_MUL4_2 (.clk(clk),
                                    .reset(reset),
                                    .enb(enb),
                                    ...
                                    .twdlXdin_8_re(twdlXdin_8_re),  // sfix15_En10
                                    .twdlXdin_8_im(twdlXdin_8_im)  // sfix15_En10
                                    );
