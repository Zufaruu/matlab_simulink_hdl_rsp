// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF2_4_block8.v
...
module RADIX22FFT_SDNF2_4_block8
  ...
  input   signed [14:0] dout_19_re;  // sfix15_En10
  input   signed [14:0] dout_19_im;  // sfix15_En10
  input   signed [14:0] dout_23_re;  // sfix15_En10
  input   signed [14:0] dout_23_im;  // sfix15_En10
  input   dout_1_vld;
  output  signed [15:0] dout_19_re_1;  // sfix16_En10
  output  signed [15:0] dout_19_im_1;  // sfix16_En10
  output  signed [15:0] dout_20_re;  // sfix16_En10
  output  signed [15:0] dout_20_im;  // sfix16_En10
  ...
  reg signed [15:0] dout_19_re_2;  // sfix16_En10
  reg signed [15:0] dout_19_im_2;  // sfix16_En10
  reg signed [15:0] dout_20_re_1;  // sfix16_En10
  reg signed [15:0] dout_20_im_1;  // sfix16_En10
  reg  dout_4_vld;
  ...
  assign din1_re = {dout_19_re[14], dout_19_re};



  assign din1_im = {dout_19_im[14], dout_19_im};



  assign din2_re = {dout_23_re[14], dout_23_re};



  assign din2_im = {dout_23_im[14], dout_23_im};
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
    ...
    dout_19_re_2 = Radix22ButterflyG2_NF_btf1_re_reg[15:0];
    dout_19_im_2 = Radix22ButterflyG2_NF_btf1_im_reg[15:0];
    dout_20_re_1 = Radix22ButterflyG2_NF_btf2_re_reg[15:0];
    dout_20_im_1 = Radix22ButterflyG2_NF_btf2_im_reg[15:0];
