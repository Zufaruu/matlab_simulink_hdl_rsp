// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF2_4_block6.v
...
module RADIX22FFT_SDNF2_4_block6
  ...
  input   signed [14:0] dout_12_re;  // sfix15_En10
  input   signed [14:0] dout_12_im;  // sfix15_En10
  input   signed [14:0] dout_16_re;  // sfix15_En10
  input   signed [14:0] dout_16_im;  // sfix15_En10
  input   dout_1_vld;
  output  signed [15:0] dout_15_re;  // sfix16_En10
  output  signed [15:0] dout_15_im;  // sfix16_En10
  output  signed [15:0] dout_16_re_1;  // sfix16_En10
  output  signed [15:0] dout_16_im_1;  // sfix16_En10
  ...
  reg signed [15:0] dout_15_re_1;  // sfix16_En10
  reg signed [15:0] dout_15_im_1;  // sfix16_En10
  reg signed [15:0] dout_16_re_2;  // sfix16_En10
  reg signed [15:0] dout_16_im_2;  // sfix16_En10
  reg  dout_4_vld;
  ...
  assign din1_re = {dout_12_re[14], dout_12_re};



  assign din1_im = {dout_12_im[14], dout_12_im};



  assign din2_re = {dout_16_re[14], dout_16_re};



  assign din2_im = {dout_16_im[14], dout_16_im};
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
    ...
    dout_15_re_1 = Radix22ButterflyG2_NF_btf1_re_reg[15:0];
    dout_15_im_1 = Radix22ButterflyG2_NF_btf1_im_reg[15:0];
    dout_16_re_2 = Radix22ButterflyG2_NF_btf2_re_reg[15:0];
    dout_16_im_2 = Radix22ButterflyG2_NF_btf2_im_reg[15:0];
