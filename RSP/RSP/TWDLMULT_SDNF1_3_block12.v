// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\TWDLMULT_SDNF1_3_block12.v
...
module TWDLMULT_SDNF1_3_block12
  ...
  input   reset;
  input   enb;
  input   signed [13:0] dout_22_re;  // sfix14_En10
  input   signed [13:0] dout_22_im;  // sfix14_En10
  input   signed [13:0] dout_24_re;  // sfix14_En10
  input   signed [13:0] dout_24_im;  // sfix14_En10
  input   dout_2_vld;
  input   signed [11:0] twdl_3_27_re;  // sfix12_En10
  input   signed [11:0] twdl_3_27_im;  // sfix12_En10
  input   signed [11:0] twdl_3_28_re;  // sfix12_En10
  input   signed [11:0] twdl_3_28_im;  // sfix12_En10
  output  signed [14:0] twdlXdin_27_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_27_im;  // sfix15_En10
  output  signed [14:0] twdlXdin_28_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_28_im;  // sfix15_En10
  ...
  assign din_re = {dout_22_re[13], dout_22_re};
  ...
  assign din_im = {dout_22_im[13], dout_22_im};
  ...
  Complex4Multiply_block21 u_MUL4_1 (.clk(clk),
                                     .reset(reset),
                                     .enb(enb),
                                     ...
                                     .twdlXdin_27_re(twdlXdin_27_re),  // sfix15_En10
                                     .twdlXdin_27_im(twdlXdin_27_im)  // sfix15_En10
                                     );

  assign din_re_1 = {dout_24_re[13], dout_24_re};
  ...
  assign din_im_1 = {dout_24_im[13], dout_24_im};
  ...
  Complex4Multiply_block22 u_MUL4_2 (.clk(clk),
                                     ...
                                     .twdlXdin_28_re(twdlXdin_28_re),  // sfix15_En10
                                     .twdlXdin_28_im(twdlXdin_28_im)  // sfix15_En10
                                     );

endmodule  // TWDLMULT_SDNF1_3_block12
