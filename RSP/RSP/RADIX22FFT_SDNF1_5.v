// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF1_5.v
...
module RADIX22FFT_SDNF1_5
  ...
  input   reset;
  input   enb;
  input   signed [15:0] dout_1_re;  // sfix16_En10
  input   signed [15:0] dout_1_im;  // sfix16_En10
  input   signed [15:0] dout_3_re;  // sfix16_En10
  input   signed [15:0] dout_3_im;  // sfix16_En10
  input   dout_4_vld;
  input   signed [11:0] twdl_5_2_re;  // sfix12_En10
  input   signed [11:0] twdl_5_2_im;  // sfix12_En10
  output  signed [16:0] dout_1_re_1;  // sfix17_En10
  output  signed [16:0] dout_1_im_1;  // sfix17_En10
  output  signed [16:0] dout_2_re;  // sfix17_En10
  output  signed [16:0] dout_2_im;  // sfix17_En10
  output  dout_2_vld;
  ...
  reg signed [16:0] dout_1_re_2;  // sfix17_En10
  reg signed [16:0] dout_1_im_2;  // sfix17_En10
  reg signed [16:0] dout_2_re_1;  // sfix17_En10
  reg signed [16:0] dout_2_im_1;  // sfix17_En10
  reg  dout_2_vld_1;
  ...
  assign din_re = {dout_1_re[15], dout_1_re};
  ...
  assign din_im = {dout_1_im[15], dout_1_im};
  ...
  assign din_re_1 = {dout_3_re[15], dout_3_re};
  ...
  assign din_im_1 = {dout_3_im[15], dout_3_im};
  ...
  Complex4Multiply_block27 u_MUL4_2 (.clk(clk),
                                     .reset(reset),
                                     .enb(enb),
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    dout_1_re_2 = Radix22ButterflyG1_NF_btf1_re_reg[16:0];
    dout_1_im_2 = Radix22ButterflyG1_NF_btf1_im_reg[16:0];
    dout_2_re_1 = Radix22ButterflyG1_NF_btf2_re_reg[16:0];
    dout_2_im_1 = Radix22ButterflyG1_NF_btf2_im_reg[16:0];
