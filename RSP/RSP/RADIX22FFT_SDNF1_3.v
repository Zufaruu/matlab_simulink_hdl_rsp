// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF1_3.v
...
module RADIX22FFT_SDNF1_3
  ...
  input   reset;
  input   enb;
  input   signed [14:0] twdlXdin_1_re;  // sfix15_En10
  input   signed [14:0] twdlXdin_1_im;  // sfix15_En10
  input   signed [14:0] twdlXdin_5_re;  // sfix15_En10
  input   signed [14:0] twdlXdin_5_im;  // sfix15_En10
  input   twdlXdin_1_vld;
  output  signed [14:0] dout_1_re;  // sfix15_En10
  output  signed [14:0] dout_1_im;  // sfix15_En10
  output  signed [14:0] dout_2_re;  // sfix15_En10
  output  signed [14:0] dout_2_im;  // sfix15_En10
  output  dout_1_vld;
  ...
  reg signed [14:0] dout_1_re_1;  // sfix15_En10
  reg signed [14:0] dout_1_im_1;  // sfix15_En10
  reg signed [14:0] dout_2_re_1;  // sfix15_En10
  reg signed [14:0] dout_2_im_1;  // sfix15_En10
  reg  dout_1_vld_1;
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    if (twdlXdin_1_vld) begin
      Radix22ButterflyG1_NF_add_cast = {twdlXdin_1_re[14], twdlXdin_1_re};
      Radix22ButterflyG1_NF_add_cast_0 = {twdlXdin_5_re[14], twdlXdin_5_re};
      Radix22ButterflyG1_NF_btf1_re_reg_next = Radix22ButterflyG1_NF_add_cast + Radix22ButterflyG1_NF_add_cast_0;
      Radix22ButterflyG1_NF_sub_cast = {twdlXdin_1_re[14], twdlXdin_1_re};
      Radix22ButterflyG1_NF_sub_cast_0 = {twdlXdin_5_re[14], twdlXdin_5_re};
      Radix22ButterflyG1_NF_btf2_re_reg_next = Radix22ButterflyG1_NF_sub_cast - Radix22ButterflyG1_NF_sub_cast_0;
      Radix22ButterflyG1_NF_add_cast_1 = {twdlXdin_1_im[14], twdlXdin_1_im};
      Radix22ButterflyG1_NF_add_cast_2 = {twdlXdin_5_im[14], twdlXdin_5_im};
      Radix22ButterflyG1_NF_btf1_im_reg_next = Radix22ButterflyG1_NF_add_cast_1 + Radix22ButterflyG1_NF_add_cast_2;
      Radix22ButterflyG1_NF_sub_cast_1 = {twdlXdin_1_im[14], twdlXdin_1_im};
      Radix22ButterflyG1_NF_sub_cast_2 = {twdlXdin_5_im[14], twdlXdin_5_im};
      Radix22ButterflyG1_NF_btf2_im_reg_next = Radix22ButterflyG1_NF_sub_cast_1 - Radix22ButterflyG1_NF_sub_cast_2;
    end
    dout_1_re_1 = Radix22ButterflyG1_NF_btf1_re_reg[14:0];
    dout_1_im_1 = Radix22ButterflyG1_NF_btf1_im_reg[14:0];
    dout_2_re_1 = Radix22ButterflyG1_NF_btf2_re_reg[14:0];
    dout_2_im_1 = Radix22ButterflyG1_NF_btf2_im_reg[14:0];
