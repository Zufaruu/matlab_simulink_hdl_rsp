// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF1_1_block9.v
...
module RADIX22FFT_SDNF1_1_block9
  ...
  input   reset;
  input   enb;
  input   signed [12:0] twdlXdin_11_re;  // sfix13_En10
  input   signed [12:0] twdlXdin_11_im;  // sfix13_En10
  input   signed [12:0] twdlXdin_27_re;  // sfix13_En10
  input   signed [12:0] twdlXdin_27_im;  // sfix13_En10
  input   twdlXdin_1_vld;
  output  signed [12:0] dout_21_re;  // sfix13_En10
  output  signed [12:0] dout_21_im;  // sfix13_En10
  output  signed [12:0] dout_22_re;  // sfix13_En10
  output  signed [12:0] dout_22_im;  // sfix13_En10
  ...
  reg signed [12:0] dout_21_re_1;  // sfix13_En10
  reg signed [12:0] dout_21_im_1;  // sfix13_En10
  reg signed [12:0] dout_22_re_1;  // sfix13_En10
  reg signed [12:0] dout_22_im_1;  // sfix13_En10
  reg  dout_21_vld;
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    if (twdlXdin_1_vld) begin
      Radix22ButterflyG1_NF_add_cast = {twdlXdin_11_re[12], twdlXdin_11_re};
      Radix22ButterflyG1_NF_add_cast_0 = {twdlXdin_27_re[12], twdlXdin_27_re};
      Radix22ButterflyG1_NF_btf1_re_reg_next = Radix22ButterflyG1_NF_add_cast + Radix22ButterflyG1_NF_add_cast_0;
      Radix22ButterflyG1_NF_sub_cast = {twdlXdin_11_re[12], twdlXdin_11_re};
      Radix22ButterflyG1_NF_sub_cast_0 = {twdlXdin_27_re[12], twdlXdin_27_re};
      Radix22ButterflyG1_NF_btf2_re_reg_next = Radix22ButterflyG1_NF_sub_cast - Radix22ButterflyG1_NF_sub_cast_0;
      Radix22ButterflyG1_NF_add_cast_1 = {twdlXdin_11_im[12], twdlXdin_11_im};
      Radix22ButterflyG1_NF_add_cast_2 = {twdlXdin_27_im[12], twdlXdin_27_im};
      Radix22ButterflyG1_NF_btf1_im_reg_next = Radix22ButterflyG1_NF_add_cast_1 + Radix22ButterflyG1_NF_add_cast_2;
      Radix22ButterflyG1_NF_sub_cast_1 = {twdlXdin_11_im[12], twdlXdin_11_im};
      Radix22ButterflyG1_NF_sub_cast_2 = {twdlXdin_27_im[12], twdlXdin_27_im};
      Radix22ButterflyG1_NF_btf2_im_reg_next = Radix22ButterflyG1_NF_sub_cast_1 - Radix22ButterflyG1_NF_sub_cast_2;
    end
    dout_21_re_1 = Radix22ButterflyG1_NF_btf1_re_reg[12:0];
    dout_21_im_1 = Radix22ButterflyG1_NF_btf1_im_reg[12:0];
    dout_22_re_1 = Radix22ButterflyG1_NF_btf2_re_reg[12:0];
    dout_22_im_1 = Radix22ButterflyG1_NF_btf2_im_reg[12:0];
...
endmodule  // RADIX22FFT_SDNF1_1_block9
