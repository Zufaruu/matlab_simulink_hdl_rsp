// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\TWDLMULT_SDNF1_3_block9.v
...
module TWDLMULT_SDNF1_3_block9
  ...
  input   reset;
  input   enb;
  input   signed [13:0] dout_25_re;  // sfix14_En10
  input   signed [13:0] dout_25_im;  // sfix14_En10
  input   signed [13:0] dout_27_re;  // sfix14_En10
  input   signed [13:0] dout_27_im;  // sfix14_En10
  input   dout_2_vld;
  input   signed [11:0] twdl_3_21_re;  // sfix12_En10
  input   signed [11:0] twdl_3_21_im;  // sfix12_En10
  input   signed [11:0] twdl_3_22_re;  // sfix12_En10
  input   signed [11:0] twdl_3_22_im;  // sfix12_En10
  output  signed [14:0] twdlXdin_21_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_21_im;  // sfix15_En10
  output  signed [14:0] twdlXdin_22_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_22_im;  // sfix15_En10
  ...
  assign din_re = {dout_25_re[13], dout_25_re};
  ...
  assign din_im = {dout_25_im[13], dout_25_im};
  ...
  Complex4Multiply_block16 u_MUL4_1 (.clk(clk),
                                     ...
                                     .twdlXdin_21_re(twdlXdin_21_re),  // sfix15_En10
                                     .twdlXdin_21_im(twdlXdin_21_im)  // sfix15_En10
                                     );

  assign din_re_1 = {dout_27_re[13], dout_27_re};
  ...
  assign din_im_1 = {dout_27_im[13], dout_27_im};
  ...
  Complex4Multiply_block17 u_MUL4_2 (.clk(clk),
                                     ...
                                     .twdlXdin_22_re(twdlXdin_22_re),  // sfix15_En10
                                     .twdlXdin_22_im(twdlXdin_22_im)  // sfix15_En10
                                     );

endmodule  // TWDLMULT_SDNF1_3_block9
