// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF1_1_block14.v
...
module RADIX22FFT_SDNF1_1_block14
  ...
  input   reset;
  input   enb;
  input   signed [12:0] twdlXdin_16_re;  // sfix13_En10
  input   signed [12:0] twdlXdin_16_im;  // sfix13_En10
  input   signed [12:0] twdlXdin_32_re;  // sfix13_En10
  input   signed [12:0] twdlXdin_32_im;  // sfix13_En10
  input   twdlXdin_1_vld;
  output  signed [12:0] dout_31_re;  // sfix13_En10
  output  signed [12:0] dout_31_im;  // sfix13_En10
  output  signed [12:0] dout_32_re;  // sfix13_En10
  output  signed [12:0] dout_32_im;  // sfix13_En10
  ...
  reg signed [12:0] dout_31_re_1;  // sfix13_En10
  reg signed [12:0] dout_31_im_1;  // sfix13_En10
  reg signed [12:0] dout_32_re_1;  // sfix13_En10
  reg signed [12:0] dout_32_im_1;  // sfix13_En10
  reg  dout_31_vld;
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
       ...
       Radix22ButterflyG1_NF_dinXtwdl_vld_dly1, twdlXdin_16_im, twdlXdin_16_re,
       twdlXdin_1_vld, twdlXdin_32_im, twdlXdin_32_re) begin
    ...
    if (twdlXdin_1_vld) begin
      Radix22ButterflyG1_NF_add_cast = {twdlXdin_16_re[12], twdlXdin_16_re};
      Radix22ButterflyG1_NF_add_cast_0 = {twdlXdin_32_re[12], twdlXdin_32_re};
      Radix22ButterflyG1_NF_btf1_re_reg_next = Radix22ButterflyG1_NF_add_cast + Radix22ButterflyG1_NF_add_cast_0;
      Radix22ButterflyG1_NF_sub_cast = {twdlXdin_16_re[12], twdlXdin_16_re};
      Radix22ButterflyG1_NF_sub_cast_0 = {twdlXdin_32_re[12], twdlXdin_32_re};
      Radix22ButterflyG1_NF_btf2_re_reg_next = Radix22ButterflyG1_NF_sub_cast - Radix22ButterflyG1_NF_sub_cast_0;
      Radix22ButterflyG1_NF_add_cast_1 = {twdlXdin_16_im[12], twdlXdin_16_im};
      Radix22ButterflyG1_NF_add_cast_2 = {twdlXdin_32_im[12], twdlXdin_32_im};
      Radix22ButterflyG1_NF_btf1_im_reg_next = Radix22ButterflyG1_NF_add_cast_1 + Radix22ButterflyG1_NF_add_cast_2;
      Radix22ButterflyG1_NF_sub_cast_1 = {twdlXdin_16_im[12], twdlXdin_16_im};
      Radix22ButterflyG1_NF_sub_cast_2 = {twdlXdin_32_im[12], twdlXdin_32_im};
      Radix22ButterflyG1_NF_btf2_im_reg_next = Radix22ButterflyG1_NF_sub_cast_1 - Radix22ButterflyG1_NF_sub_cast_2;
    end
    dout_31_re_1 = Radix22ButterflyG1_NF_btf1_re_reg[12:0];
    dout_31_im_1 = Radix22ButterflyG1_NF_btf1_im_reg[12:0];
    dout_32_re_1 = Radix22ButterflyG1_NF_btf2_re_reg[12:0];
    dout_32_im_1 = Radix22ButterflyG1_NF_btf2_im_reg[12:0];
...
endmodule  // RADIX22FFT_SDNF1_1_block14
