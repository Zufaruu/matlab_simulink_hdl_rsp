// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\TWDLMULT_SDNF1_3_block6.v
...
module TWDLMULT_SDNF1_3_block6
  ...
  input   reset;
  input   enb;
  input   signed [13:0] dout_14_re;  // sfix14_En10
  input   signed [13:0] dout_14_im;  // sfix14_En10
  input   signed [13:0] dout_16_re;  // sfix14_En10
  input   signed [13:0] dout_16_im;  // sfix14_En10
  input   dout_2_vld;
  input   signed [11:0] twdl_3_15_re;  // sfix12_En10
  input   signed [11:0] twdl_3_15_im;  // sfix12_En10
  input   signed [11:0] twdl_3_16_re;  // sfix12_En10
  input   signed [11:0] twdl_3_16_im;  // sfix12_En10
  output  signed [14:0] twdlXdin_15_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_15_im;  // sfix15_En10
  output  signed [14:0] twdlXdin_16_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_16_im;  // sfix15_En10
  ...
  assign din_re = {dout_14_re[13], dout_14_re};
  ...
  assign din_im = {dout_14_im[13], dout_14_im};
  ...
  Complex4Multiply_block11 u_MUL4_1 (.clk(clk),
                                     .reset(reset),
                                     .enb(enb),
                                     ...
                                     .twdlXdin_15_re(twdlXdin_15_re),  // sfix15_En10
                                     .twdlXdin_15_im(twdlXdin_15_im)  // sfix15_En10
                                     );

  assign din_re_1 = {dout_16_re[13], dout_16_re};
  ...
  assign din_im_1 = {dout_16_im[13], dout_16_im};
  ...
  Complex4Multiply_block12 u_MUL4_2 (.clk(clk),
                                     .reset(reset),
                                     .enb(enb),
                                     ...
                                     .twdlXdin_16_re(twdlXdin_16_re),  // sfix15_En10
                                     .twdlXdin_16_im(twdlXdin_16_im)  // sfix15_En10
                                     );

endmodule  // TWDLMULT_SDNF1_3_block6
