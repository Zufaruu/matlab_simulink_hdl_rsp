// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\TWDLMULT_SDNF1_3_block4.v
...
module TWDLMULT_SDNF1_3_block4
  ...
  input   reset;
  input   enb;
  input   signed [13:0] dout_6_re;  // sfix14_En10
  input   signed [13:0] dout_6_im;  // sfix14_En10
  input   signed [13:0] dout_8_re;  // sfix14_En10
  input   signed [13:0] dout_8_im;  // sfix14_En10
  input   dout_2_vld;
  input   signed [11:0] twdl_3_11_re;  // sfix12_En10
  input   signed [11:0] twdl_3_11_im;  // sfix12_En10
  input   signed [11:0] twdl_3_12_re;  // sfix12_En10
  input   signed [11:0] twdl_3_12_im;  // sfix12_En10
  output  signed [14:0] twdlXdin_11_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_11_im;  // sfix15_En10
  output  signed [14:0] twdlXdin_12_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_12_im;  // sfix15_En10
  ...
  assign din_re = {dout_6_re[13], dout_6_re};
  ...
  assign din_im = {dout_6_im[13], dout_6_im};
  ...
  Complex4Multiply_block7 u_MUL4_1 (.clk(clk),
                                    .reset(reset),
                                    .enb(enb),
                                    ...
                                    .twdlXdin_11_re(twdlXdin_11_re),  // sfix15_En10
                                    .twdlXdin_11_im(twdlXdin_11_im)  // sfix15_En10
                                    );

  assign din_re_1 = {dout_8_re[13], dout_8_re};
  ...
  assign din_im_1 = {dout_8_im[13], dout_8_im};
  ...
  Complex4Multiply_block8 u_MUL4_2 (.clk(clk),
                                    .reset(reset),
                                    .enb(enb),
                                    ...
                                    .twdlXdin_12_re(twdlXdin_12_re),  // sfix15_En10
                                    .twdlXdin_12_im(twdlXdin_12_im)  // sfix15_En10
                                    );

endmodule  // TWDLMULT_SDNF1_3_block4
