// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF1_3_block.v
...
module RADIX22FFT_SDNF1_3_block
  ...
  input   reset;
  input   enb;
  input   signed [14:0] twdlXdin_2_re;  // sfix15_En10
  input   signed [14:0] twdlXdin_2_im;  // sfix15_En10
  input   signed [14:0] twdlXdin_6_re;  // sfix15_En10
  input   signed [14:0] twdlXdin_6_im;  // sfix15_En10
  input   twdlXdin_1_vld;
  output  signed [14:0] dout_3_re;  // sfix15_En10
  output  signed [14:0] dout_3_im;  // sfix15_En10
  output  signed [14:0] dout_4_re;  // sfix15_En10
  output  signed [14:0] dout_4_im;  // sfix15_En10
  ...
  reg signed [14:0] dout_3_re_1;  // sfix15_En10
  reg signed [14:0] dout_3_im_1;  // sfix15_En10
  reg signed [14:0] dout_4_re_1;  // sfix15_En10
  reg signed [14:0] dout_4_im_1;  // sfix15_En10
  reg  dout_3_vld;
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    if (twdlXdin_1_vld) begin
      Radix22ButterflyG1_NF_add_cast = {twdlXdin_2_re[14], twdlXdin_2_re};
      Radix22ButterflyG1_NF_add_cast_0 = {twdlXdin_6_re[14], twdlXdin_6_re};
      Radix22ButterflyG1_NF_btf1_re_reg_next = Radix22ButterflyG1_NF_add_cast + Radix22ButterflyG1_NF_add_cast_0;
      Radix22ButterflyG1_NF_sub_cast = {twdlXdin_2_re[14], twdlXdin_2_re};
      Radix22ButterflyG1_NF_sub_cast_0 = {twdlXdin_6_re[14], twdlXdin_6_re};
      Radix22ButterflyG1_NF_btf2_re_reg_next = Radix22ButterflyG1_NF_sub_cast - Radix22ButterflyG1_NF_sub_cast_0;
      Radix22ButterflyG1_NF_add_cast_1 = {twdlXdin_2_im[14], twdlXdin_2_im};
      Radix22ButterflyG1_NF_add_cast_2 = {twdlXdin_6_im[14], twdlXdin_6_im};
      Radix22ButterflyG1_NF_btf1_im_reg_next = Radix22ButterflyG1_NF_add_cast_1 + Radix22ButterflyG1_NF_add_cast_2;
      Radix22ButterflyG1_NF_sub_cast_1 = {twdlXdin_2_im[14], twdlXdin_2_im};
      Radix22ButterflyG1_NF_sub_cast_2 = {twdlXdin_6_im[14], twdlXdin_6_im};
      Radix22ButterflyG1_NF_btf2_im_reg_next = Radix22ButterflyG1_NF_sub_cast_1 - Radix22ButterflyG1_NF_sub_cast_2;
    end
    dout_3_re_1 = Radix22ButterflyG1_NF_btf1_re_reg[14:0];
    dout_3_im_1 = Radix22ButterflyG1_NF_btf1_im_reg[14:0];
    dout_4_re_1 = Radix22ButterflyG1_NF_btf2_re_reg[14:0];
    dout_4_im_1 = Radix22ButterflyG1_NF_btf2_im_reg[14:0];
