// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF1_5_block9.v
...
module RADIX22FFT_SDNF1_5_block9
  ...
  input   reset;
  input   enb;
  input   signed [15:0] dout_21_re;  // sfix16_En10
  input   signed [15:0] dout_21_im;  // sfix16_En10
  input   signed [15:0] dout_23_re;  // sfix16_En10
  input   signed [15:0] dout_23_im;  // sfix16_En10
  input   dout_4_vld;
  input   signed [11:0] twdl_5_22_re;  // sfix12_En10
  input   signed [11:0] twdl_5_22_im;  // sfix12_En10
  output  signed [16:0] dout_21_re_1;  // sfix17_En10
  output  signed [16:0] dout_21_im_1;  // sfix17_En10
  output  signed [16:0] dout_22_re;  // sfix17_En10
  output  signed [16:0] dout_22_im;  // sfix17_En10
  ...
  reg signed [16:0] dout_21_re_2;  // sfix17_En10
  reg signed [16:0] dout_21_im_2;  // sfix17_En10
  reg signed [16:0] dout_22_re_1;  // sfix17_En10
  reg signed [16:0] dout_22_im_1;  // sfix17_En10
  reg  dout_22_vld;
  ...
  assign din_re = {dout_21_re[15], dout_21_re};
  ...
  assign din_im = {dout_21_im[15], dout_21_im};
  ...
  assign din_re_1 = {dout_23_re[15], dout_23_re};
  ...
  assign din_im_1 = {dout_23_im[15], dout_23_im};
  ...
  Complex4Multiply_block37 u_MUL4_2 (.clk(clk),
                                     .reset(reset),
                                     .enb(enb),
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    dout_21_re_2 = Radix22ButterflyG1_NF_btf1_re_reg[16:0];
    dout_21_im_2 = Radix22ButterflyG1_NF_btf1_im_reg[16:0];
    dout_22_re_1 = Radix22ButterflyG1_NF_btf2_re_reg[16:0];
    dout_22_im_1 = Radix22ButterflyG1_NF_btf2_im_reg[16:0];
    dout_22_vld = Radix22ButterflyG1_NF_dinXtwdl_vld_dly1;
  end



  assign dout_21_re_1 = dout_21_re_2;

  assign dout_21_im_1 = dout_21_im_2;

  assign dout_22_re = dout_22_re_1;

  assign dout_22_im = dout_22_im_1;

endmodule  // RADIX22FFT_SDNF1_5_block9
