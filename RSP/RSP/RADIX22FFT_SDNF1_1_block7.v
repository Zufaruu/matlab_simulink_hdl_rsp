// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF1_1_block7.v
...
module RADIX22FFT_SDNF1_1_block7
  ...
  input   reset;
  input   enb;
  input   signed [12:0] twdlXdin_9_re;  // sfix13_En10
  input   signed [12:0] twdlXdin_9_im;  // sfix13_En10
  input   signed [12:0] twdlXdin_25_re;  // sfix13_En10
  input   signed [12:0] twdlXdin_25_im;  // sfix13_En10
  input   twdlXdin_1_vld;
  output  signed [12:0] dout_17_re;  // sfix13_En10
  output  signed [12:0] dout_17_im;  // sfix13_En10
  output  signed [12:0] dout_18_re;  // sfix13_En10
  output  signed [12:0] dout_18_im;  // sfix13_En10
  ...
  reg signed [12:0] dout_17_re_1;  // sfix13_En10
  reg signed [12:0] dout_17_im_1;  // sfix13_En10
  reg signed [12:0] dout_18_re_1;  // sfix13_En10
  reg signed [12:0] dout_18_im_1;  // sfix13_En10
  reg  dout_17_vld;
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    if (twdlXdin_1_vld) begin
      Radix22ButterflyG1_NF_add_cast = {twdlXdin_9_re[12], twdlXdin_9_re};
      Radix22ButterflyG1_NF_add_cast_0 = {twdlXdin_25_re[12], twdlXdin_25_re};
      Radix22ButterflyG1_NF_btf1_re_reg_next = Radix22ButterflyG1_NF_add_cast + Radix22ButterflyG1_NF_add_cast_0;
      Radix22ButterflyG1_NF_sub_cast = {twdlXdin_9_re[12], twdlXdin_9_re};
      Radix22ButterflyG1_NF_sub_cast_0 = {twdlXdin_25_re[12], twdlXdin_25_re};
      Radix22ButterflyG1_NF_btf2_re_reg_next = Radix22ButterflyG1_NF_sub_cast - Radix22ButterflyG1_NF_sub_cast_0;
      Radix22ButterflyG1_NF_add_cast_1 = {twdlXdin_9_im[12], twdlXdin_9_im};
      Radix22ButterflyG1_NF_add_cast_2 = {twdlXdin_25_im[12], twdlXdin_25_im};
      Radix22ButterflyG1_NF_btf1_im_reg_next = Radix22ButterflyG1_NF_add_cast_1 + Radix22ButterflyG1_NF_add_cast_2;
      Radix22ButterflyG1_NF_sub_cast_1 = {twdlXdin_9_im[12], twdlXdin_9_im};
      Radix22ButterflyG1_NF_sub_cast_2 = {twdlXdin_25_im[12], twdlXdin_25_im};
      Radix22ButterflyG1_NF_btf2_im_reg_next = Radix22ButterflyG1_NF_sub_cast_1 - Radix22ButterflyG1_NF_sub_cast_2;
    end
    dout_17_re_1 = Radix22ButterflyG1_NF_btf1_re_reg[12:0];
    dout_17_im_1 = Radix22ButterflyG1_NF_btf1_im_reg[12:0];
    dout_18_re_1 = Radix22ButterflyG1_NF_btf2_re_reg[12:0];
    dout_18_im_1 = Radix22ButterflyG1_NF_btf2_im_reg[12:0];
...
endmodule  // RADIX22FFT_SDNF1_1_block7
