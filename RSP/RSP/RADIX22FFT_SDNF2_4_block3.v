// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF2_4_block3.v
...
module RADIX22FFT_SDNF2_4_block3
  ...
  input   signed [14:0] dout_9_re;  // sfix15_En10
  input   signed [14:0] dout_9_im;  // sfix15_En10
  input   signed [14:0] dout_13_re;  // sfix15_En10
  input   signed [14:0] dout_13_im;  // sfix15_En10
  input   dout_1_vld;
  output  signed [15:0] dout_9_re_1;  // sfix16_En10
  output  signed [15:0] dout_9_im_1;  // sfix16_En10
  output  signed [15:0] dout_10_re;  // sfix16_En10
  output  signed [15:0] dout_10_im;  // sfix16_En10
  ...
  reg signed [15:0] dout_9_re_2;  // sfix16_En10
  reg signed [15:0] dout_9_im_2;  // sfix16_En10
  reg signed [15:0] dout_10_re_1;  // sfix16_En10
  reg signed [15:0] dout_10_im_1;  // sfix16_En10
  reg  dout_4_vld;
  ...
  assign din1_re = {dout_9_re[14], dout_9_re};



  assign din1_im = {dout_9_im[14], dout_9_im};



  assign din2_re = {dout_13_re[14], dout_13_re};



  assign din2_im = {dout_13_im[14], dout_13_im};
  ...
  always @(Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
    ...
    dout_9_re_2 = Radix22ButterflyG2_NF_btf1_re_reg[15:0];
    dout_9_im_2 = Radix22ButterflyG2_NF_btf1_im_reg[15:0];
    dout_10_re_1 = Radix22ButterflyG2_NF_btf2_re_reg[15:0];
    dout_10_im_1 = Radix22ButterflyG2_NF_btf2_im_reg[15:0];
