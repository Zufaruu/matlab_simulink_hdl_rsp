// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\TWDLMULT_SDNF1_3.v
...
module TWDLMULT_SDNF1_3
  ...
  input   reset;
  input   enb;
  input   signed [13:0] dout_1_re;  // sfix14_En10
  input   signed [13:0] dout_1_im;  // sfix14_En10
  input   signed [13:0] dout_3_re;  // sfix14_En10
  input   signed [13:0] dout_3_im;  // sfix14_En10
  input   dout_2_vld;
  input   signed [11:0] twdl_3_2_re;  // sfix12_En10
  input   signed [11:0] twdl_3_2_im;  // sfix12_En10
  output  signed [14:0] twdlXdin_1_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_1_im;  // sfix15_En10
  output  signed [14:0] twdlXdin_2_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_2_im;  // sfix15_En10
  ...
  assign din_re = {dout_1_re[13], dout_1_re};
  ...
  assign din_im = {dout_1_im[13], dout_1_im};
  ...
  assign din_re_1 = {dout_3_re[13], dout_3_re};
  ...
  assign din_im_1 = {dout_3_im[13], dout_3_im};
  ...
  Complex4Multiply u_MUL4_2 (.clk(clk),
                             ...
                             .twdlXdin_2_re(twdlXdin_2_re),  // sfix15_En10
                             .twdlXdin_2_im(twdlXdin_2_im),  // sfix15_En10
