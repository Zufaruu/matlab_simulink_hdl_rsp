// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\TWDLMULT_SDNF1_3_block11.v
...
module TWDLMULT_SDNF1_3_block11
  ...
  input   reset;
  input   enb;
  input   signed [13:0] dout_18_re;  // sfix14_En10
  input   signed [13:0] dout_18_im;  // sfix14_En10
  input   signed [13:0] dout_20_re;  // sfix14_En10
  input   signed [13:0] dout_20_im;  // sfix14_En10
  input   dout_2_vld;
  input   signed [11:0] twdl_3_26_re;  // sfix12_En10
  input   signed [11:0] twdl_3_26_im;  // sfix12_En10
  output  signed [14:0] twdlXdin_25_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_25_im;  // sfix15_En10
  output  signed [14:0] twdlXdin_26_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_26_im;  // sfix15_En10
  ...
  reg signed [14:0] din1_re_dly4;  // sfix15_En10
  reg signed [14:0] din1_re_dly5;  // sfix15_En10
  reg signed [14:0] din1_re_dly6;  // sfix15_En10
  reg signed [14:0] din1_re_dly7;  // sfix15_En10
  reg signed [14:0] din1_re_dly8;  // sfix15_En10
  reg signed [14:0] din1_re_dly9;  // sfix15_En10
  ...
  reg signed [14:0] din1_im_dly4;  // sfix15_En10
  reg signed [14:0] din1_im_dly5;  // sfix15_En10
  reg signed [14:0] din1_im_dly6;  // sfix15_En10
  reg signed [14:0] din1_im_dly7;  // sfix15_En10
  reg signed [14:0] din1_im_dly8;  // sfix15_En10
  reg signed [14:0] din1_im_dly9;  // sfix15_En10
  ...
  assign din_re = {dout_18_re[13], dout_18_re};
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_3_process
      if (reset == 1'b1) begin
        din1_re_dly4 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_4_process
      if (reset == 1'b1) begin
        din1_re_dly5 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_5_process
      if (reset == 1'b1) begin
        din1_re_dly6 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_6_process
      if (reset == 1'b1) begin
        din1_re_dly7 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_7_process
      if (reset == 1'b1) begin
        din1_re_dly8 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_8_process
      if (reset == 1'b1) begin
        din1_re_dly9 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign twdlXdin_25_re = din1_re_dly9;

  assign din_im = {dout_18_im[13], dout_18_im};
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_12_process
      if (reset == 1'b1) begin
        din1_im_dly4 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_13_process
      if (reset == 1'b1) begin
        din1_im_dly5 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_14_process
      if (reset == 1'b1) begin
        din1_im_dly6 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_15_process
      if (reset == 1'b1) begin
        din1_im_dly7 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_16_process
      if (reset == 1'b1) begin
        din1_im_dly8 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_17_process
      if (reset == 1'b1) begin
        din1_im_dly9 <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign twdlXdin_25_im = din1_im_dly9;

  assign din_re_1 = {dout_20_re[13], dout_20_re};
  ...
  assign din_im_1 = {dout_20_im[13], dout_20_im};
  ...
  Complex4Multiply_block20 u_MUL4_2 (.clk(clk),
                                     .reset(reset),
                                     .enb(enb),
                                     ...
                                     .twdlXdin_26_re(twdlXdin_26_re),  // sfix15_En10
                                     .twdlXdin_26_im(twdlXdin_26_im)  // sfix15_En10
                                     );

endmodule  // TWDLMULT_SDNF1_3_block11
