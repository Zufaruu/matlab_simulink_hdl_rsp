// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\TWDLMULT_SDNF1_3_block.v
...
module TWDLMULT_SDNF1_3_block
  ...
  input   reset;
  input   enb;
  input   signed [13:0] dout_5_re;  // sfix14_En10
  input   signed [13:0] dout_5_im;  // sfix14_En10
  input   signed [13:0] dout_7_re;  // sfix14_En10
  input   signed [13:0] dout_7_im;  // sfix14_En10
  input   dout_2_vld;
  input   signed [11:0] twdl_3_3_re;  // sfix12_En10
  input   signed [11:0] twdl_3_3_im;  // sfix12_En10
  input   signed [11:0] twdl_3_4_re;  // sfix12_En10
  input   signed [11:0] twdl_3_4_im;  // sfix12_En10
  output  signed [14:0] twdlXdin_3_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_3_im;  // sfix15_En10
  output  signed [14:0] twdlXdin_4_re;  // sfix15_En10
  output  signed [14:0] twdlXdin_4_im;  // sfix15_En10
  ...
  assign din_re = {dout_5_re[13], dout_5_re};
  ...
  assign din_im = {dout_5_im[13], dout_5_im};
  ...
  Complex4Multiply_block u_MUL4_1 (.clk(clk),
                                   ...
                                   .twdlXdin_3_re(twdlXdin_3_re),  // sfix15_En10
                                   .twdlXdin_3_im(twdlXdin_3_im)  // sfix15_En10
                                   );

  assign din_re_1 = {dout_7_re[13], dout_7_re};
  ...
  assign din_im_1 = {dout_7_im[13], dout_7_im};
  ...
  Complex4Multiply_block1 u_MUL4_2 (.clk(clk),
                                    ...
                                    .twdlXdin_4_re(twdlXdin_4_re),  // sfix15_En10
                                    .twdlXdin_4_im(twdlXdin_4_im)  // sfix15_En10
                                    );
