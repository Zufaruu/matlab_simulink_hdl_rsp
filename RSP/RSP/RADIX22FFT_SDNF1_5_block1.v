// -------------------------------------------------------------
// 
// File Name: C:\Users\acer\OneDrive\Documents\ITS CAK V2\Magang\BRIN\Progress\Matlab Simulink\HDL Coder\proyek\RSP\RSP\RSP\RADIX22FFT_SDNF1_5_block1.v
...
module RADIX22FFT_SDNF1_5_block1
  ...
  input   reset;
  input   enb;
  input   signed [15:0] dout_5_re;  // sfix16_En10
  input   signed [15:0] dout_5_im;  // sfix16_En10
  input   signed [15:0] dout_7_re;  // sfix16_En10
  input   signed [15:0] dout_7_im;  // sfix16_En10
  input   dout_4_vld;
  input   signed [11:0] twdl_5_6_re;  // sfix12_En10
  input   signed [11:0] twdl_5_6_im;  // sfix12_En10
  output  signed [16:0] dout_5_re_1;  // sfix17_En10
  output  signed [16:0] dout_5_im_1;  // sfix17_En10
  output  signed [16:0] dout_6_re;  // sfix17_En10
  output  signed [16:0] dout_6_im;  // sfix17_En10
  ...
  reg signed [16:0] dout_5_re_2;  // sfix17_En10
  reg signed [16:0] dout_5_im_2;  // sfix17_En10
  reg signed [16:0] dout_6_re_1;  // sfix17_En10
  reg signed [16:0] dout_6_im_1;  // sfix17_En10
  reg  dout_6_vld;
  ...
  assign din_re = {dout_5_re[15], dout_5_re};
  ...
  assign din_im = {dout_5_im[15], dout_5_im};
  ...
  assign din_re_1 = {dout_7_re[15], dout_7_re};
  ...
  assign din_im_1 = {dout_7_im[15], dout_7_im};
  ...
  always @(Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
    ...
    dout_5_re_2 = Radix22ButterflyG1_NF_btf1_re_reg[16:0];
    dout_5_im_2 = Radix22ButterflyG1_NF_btf1_im_reg[16:0];
    dout_6_re_1 = Radix22ButterflyG1_NF_btf2_re_reg[16:0];
    dout_6_im_1 = Radix22ButterflyG1_NF_btf2_im_reg[16:0];
