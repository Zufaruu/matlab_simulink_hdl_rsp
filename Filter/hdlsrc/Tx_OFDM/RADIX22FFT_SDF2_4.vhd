-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\RADIX22FFT_SDF2_4.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF2_4
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_4 IS
  ...
  -- Signals
  SIGNAL dout_3_1_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_3_1_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  u_SDFCOMMUTATOR_4 : SDFCommutator4
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix2
              wrEnb => wrEnb,
              dout_4_1_re => dout_4_1_re_tmp,  -- sfix16_En15
              dout_4_1_im => dout_4_1_im_tmp,  -- sfix16_En15
