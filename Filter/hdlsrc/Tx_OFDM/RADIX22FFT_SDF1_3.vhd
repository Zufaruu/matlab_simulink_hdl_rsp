-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\RADIX22FFT_SDF1_3.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF1_3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_MUL4 : Complex4Multiply
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_3_1_re_dly => din_3_1_re_dly,  -- sfix16_En15
              din_3_1_im_dly => din_3_1_im_dly,  -- sfix16_En15
  ...
  u_SDFCOMMUTATOR_3 : SDFCommutator3
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix3
              wrEnb => wrEnb,
              dout_3_1_re => dout_3_1_re_tmp,  -- sfix16_En15
              dout_3_1_im => dout_3_1_im_tmp,  -- sfix16_En15
