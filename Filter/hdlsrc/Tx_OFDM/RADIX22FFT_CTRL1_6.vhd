-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\RADIX22FFT_CTRL1_6.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_CTRL1_6
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_6_Enb <= '0';
        IF (SDFController_wrState = to_unsigned(16#3#, 2)) AND dout_5_1_vld = '1' THEN 
