-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\SDFCommutator3.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF1_3/SDFCommutator3
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator3 IS
  ...
  SIGNAL dout_3_1_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_3_1_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En15
