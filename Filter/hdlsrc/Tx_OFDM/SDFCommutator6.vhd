-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\SDFCommutator6.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF2_6/SDFCommutator6
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator6 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL xf_im_signed                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dinf_re_signed                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dinf_im_signed                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btf1_re_signed                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btf1_im_signed                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btf2_re_signed                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btf2_im_signed                   : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL SDFCummutator_out_im_next        : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL SDFCummutator_btf1_vld_dly_next  : std_logic;
  SIGNAL wrData_re_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL wrData_im_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL xData_re                         : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL xData_im                         : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL dout0_re                         : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout0_im                         : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL xX_re_signed                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL xX_im                            : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL xX_im_signed                     : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_6_1_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_6_1_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En15
