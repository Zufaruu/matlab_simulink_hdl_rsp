-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\TWDLROM_3_1.vhd
...
-- 
-- Module: TWDLROM_3_1
-- Source Path: Tx_OFDM/Transmitter/IFFT1/TWDLROM_3_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF dout_2_1_vld = '1' AND (Radix22TwdlMapping_cnt > to_unsigned(16#E#, 4)) THEN 
