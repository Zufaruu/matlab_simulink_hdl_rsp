-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\RADIX22FFT_SDF2_2.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF2_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_2 IS
  ...
  -- Signals
  SIGNAL dout_1_1_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_1_1_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  u_SDFCOMMUTATOR_2 : SDFCommutator2
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix4
              wrEnb => wrEnb,
              dout_2_1_re => dout_2_1_re_tmp,  -- sfix16_En15
              dout_2_1_im => dout_2_1_im_tmp,  -- sfix16_En15
