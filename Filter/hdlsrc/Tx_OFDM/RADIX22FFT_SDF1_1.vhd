-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\RADIX22FFT_SDF1_1.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF1_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_1 IS
  ...
  SIGNAL dinXTwdl_re                      : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din_1_1_im_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dinXTwdl_im                      : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  u_SDFCOMMUTATOR_1 : SDFCommutator1
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix5
              wrEnb => wrEnb,
              dout_1_1_re => dout_1_1_re_tmp,  -- sfix16_En15
              dout_1_1_im => dout_1_1_im_tmp,  -- sfix16_En15
