-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\RADIX22FFT_CTRL1_4.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_CTRL1_4
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_4_Enb <= '0';
        IF dout_3_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#3#, 2)) THEN 
