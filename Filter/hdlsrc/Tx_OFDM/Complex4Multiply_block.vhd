-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\Complex4Multiply_block.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF1_5/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex4Multiply_block IS
  ...
  -- Signals
  SIGNAL din_5_1_re_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din_re_reg                       : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din_5_1_im_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL dinXTwdl_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dinXTwdl_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En15
