-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\Complex4Multiply.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF1_3/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex4Multiply IS
  ...
  -- Signals
  SIGNAL din_3_1_re_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din_re_reg                       : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din_3_1_im_dly_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
