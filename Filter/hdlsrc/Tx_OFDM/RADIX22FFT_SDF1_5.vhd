-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\RADIX22FFT_SDF1_5.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF1_5
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_5 IS
  ...
  COMPONENT Complex4Multiply_block
    PORT( clk                             :   IN    std_logic;
          ...
          twdl_5_1_re                     :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          twdl_5_1_im                     :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          dinXTwdl_re                     :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          dinXTwdl_im                     :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          dinXTwdl_5_1_vld                :   OUT   std_logic
          );
  END COMPONENT;
  ...
  COMPONENT SDFCommutator5
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          xf_im                           :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          dinXTwdlf_im                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          btf1_im                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          btf2_re                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          btf2_im                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          wrData_im                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL dinXTwdl_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dinXTwdl_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btf2_re                          : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btf1_im                          : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btf1_re                          : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dinXTwdlf_im                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dinXTwdlf_re                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL xf_im                            : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL x_re                             : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL x_im                             : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_add_cast      : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_sra_temp      : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_sra_temp_1    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_sra_temp_2    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG1_sra_temp_3    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL xf_re                            : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  u_MUL4 : Complex4Multiply_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_5_1_re_dly => din_5_1_re_dly,  -- sfix16_En15
              din_5_1_im_dly => din_5_1_im_dly,  -- sfix16_En15
              din_5_vld_dly => din_5_vld_dly,
              twdl_5_1_re => twdl_5_1_re,  -- sfix16_En14
              twdl_5_1_im => twdl_5_1_im,  -- sfix16_En14
              dinXTwdl_re => dinXTwdl_re,  -- sfix16_En15
              dinXTwdl_im => dinXTwdl_im,  -- sfix16_En15
  ...
  u_SDFCOMMUTATOR_5 : SDFCommutator5
    PORT MAP( clk => clk,
              ...
              enb => enb,
              din_5_vld_dly => din_5_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix16_En15
              xf_im => std_logic_vector(xf_im),  -- sfix16_En15
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix16_En15
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix16_En15
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix16_En15
              btf1_im => std_logic_vector(btf1_im),  -- sfix16_En15
              btf2_re => std_logic_vector(btf2_re),  -- sfix16_En15
              btf2_im => std_logic_vector(btf2_im),  -- sfix16_En15
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix16_En15
              wrData_im => wrData_im,  -- sfix16_En15
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_5_1_re => dout_5_1_re_tmp,  -- sfix16_En15
              dout_5_1_im => dout_5_1_im_tmp,  -- sfix16_En15
