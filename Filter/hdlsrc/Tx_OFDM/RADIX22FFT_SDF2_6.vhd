-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\RADIX22FFT_SDF2_6.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF2_6
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_6 IS
  ...
  COMPONENT SDFCommutator6
    PORT( clk                             :   IN    std_logic;
          ...
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          dinf_im                         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
  ...
  -- Signals
  SIGNAL dout_5_1_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_5_1_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL saveEnb                          : std_logic;
  SIGNAL dinVld                           : std_logic;
  SIGNAL din_re_dly1                      : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btfin_re                         : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din_im_dly1                      : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btfin_im                         : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL dinf_im                          : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dinf_re                          : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL xf_im                            : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL x_im                             : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL x_im_dly                         : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL x_re_dly                         : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  u_SDFCOMMUTATOR_6 : SDFCommutator6
    PORT MAP( clk => clk,
              ...
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix16_En15
              dinf_im => std_logic_vector(dinf_im),  -- sfix16_En15
              dinf_vld => dinf_vld,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_6_1_re => dout_6_1_re_tmp,  -- sfix16_En15
              dout_6_1_im => dout_6_1_im_tmp  -- sfix16_En15
              );
