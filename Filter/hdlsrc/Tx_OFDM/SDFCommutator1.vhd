-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\Tx_OFDM\SDFCommutator1.vhd
...
-- Source Path: Tx_OFDM/Transmitter/IFFT1/RADIX22FFT_SDF1_1/SDFCommutator1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator1 IS
  ...
  SIGNAL dinXTwdlf_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dinXTwdlf_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL dout_1_1_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_1_1_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En15
